...
<head>
    ...
    <style>
        ...
        .header-bottom .has-sub .sub-menu-list a:hover {
            color: #4a20e9;
        }
        ...
        .header-bottom .has-sub .sub-menu {
            background: #0091ea;
        }
        ...
        .header-desktop .menu ul li:not(:first-child) {
            margin-left: 40px;
        }
...
<body _c_t_common="1">
            ...
            <div class="container">
                <div class="wrapper">
                    <div class="logo-wrapper">
                        <div>
                            <a href="/"><img src="{{$config->static}}/assets/images/uploaded/logo-codeby.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="left-header">
                        <div class="menu">
                            <ul>
                                ...
                                <li class="has-sub">
                                    <a href="javascript:void(0)">Dịch vụ <br />website</a>
                                    <div class="sub-menu">
                                        <div class="container">
                                ...
                                <li class="has-sub">
                                    <a href="javascript:void(0)">Dịch vụ<br /> logo</a>
                                    <div class="sub-menu">
                                        <div class="container">
                                            <div class="sub-menu-list">
                                                <a class="" href="/thiet-ke-website" title="Thiết kế website">
                                ...
                                <li class="has-sub">
                                    <a href="javascript:void(0)">Nhận diện<br /> thương hiệu</a>
                                    <div class="sub-menu">
                                        <div class="container">
                                            <div class="sub-menu-list">
                                                <a class="" href="/thiet-ke-website" title="Thiết kế website">
                                ...
                                <li class="">
                                    <a href="/gioi-thieu" title=" Giới thiệu">Thi công<br />
                                        outsource</a>
                                </li>
                                <li class="">
                                    <a href="/quy-trinh" title="Quy trình">Tool API<br />for developer</a>
                                </li>
                                <!-- <li class="">
                                ...
                                <li class="">
                                    <a href="/lien-lac" title="Liên lạc">Liên lạc</a>
                                </li>
                            </ul>
                        </div>
    ...
    <main>
        <style>
            /* .canhcam-banner-1 .swiper-wrapper {
                height: 500px;
            }
                ...
                <div class="swiper-wrapper">
                    ...
                    <!-- <div class="swiper-slide">
                        <div style="position: relative;">
                            <h1
                                style="position: absolute; left: 9%; top: 25%; color: #fff; font-size: 1.47rem; font-weight: bold;">
                                CÔNG TY THIẾT KẾ WEBSITE
                            </h1>
                            <img class="swiper-lazy"
                                src="{{$config->static}}/assets/images/uploaded/blog/thiet-ke-website-canh-cam-home-banner1.jpg"
                                alt="Were are Canh Cam banner" />
                        </div>
                        <div class="swiper-lazy-preloader"></div>
                    </div> -->
                    <div class="swiper-slide">
