@extends($config->layout.'/master') @section('main')
    ...
    <main>
        ...
        @php
            $web1 = $http->get('/web', ['search'=>'position,web-1'])->data();
            ...
            <section class="service-english-banner">
                <div class="banner-wrap">
                    <div class="banner-img">
                        ...
                        @endphp
                        <img class="lazyload srcset lazyloaded" sizes="100vw" src="{{$img}}"
                             alt="Giúp web của bạn bán hàng và thu hút khách hàng hiệu quả!"/>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="content leading-snug">
                                        ...
                                        <a class="btn btn-icon-right" id="service-first-phone-call"
                                           href="tel:{{$con['contact']['phone_number']}}"><span>Gọi cho chúng tôi</span><em
        ...
        @php
            $web2 = $http->get('/web', ['search'=>'position,web-2'])->data();
        ...
        @if($web2)
            ...
            <section class="service-vietnamse-2 section">
                <div class="container">
                    ...
                    <div class="list-item">
                        @php
                            $webSub2 = $http->get('/web-sub', ['search'=>'post,web-2'])->data();
                        @endphp
                        @foreach($webSub2 as $key => $item)
                            <div class="item">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="img text-center"><img class="lazyload lazyloaded"
        ...
        @php
            $web3 = $http->get('/web', ['search'=>'position,web-3'])->data();
                ...
                <div class="container">
                    ...
                    <div class="list-item">
                        <div class="row row-lg-5 row-sm-2">
                            @php
                                $webSub3 = $http->get('/web-sub', ['search'=>'post,web-3'])->data();
                            @endphp
                            @foreach($webSub3 as $key => $item)
                                <div class="w-100">
                                    <div class="item">
        ...
        <section style="background-image: url({{$config->static}}/assets/images/uploaded/banner/bg-2-min.jpg);"
                 class="service-english-4 section">
            <div class="container">
                <div class="row justify-center no-gutter">
                    <div class="col-lg-10">
                        ...
                        <div class="section-desc text-center leading-snug">
                            <p>
                                Bằng cách tiếp cận sáng tạo được kết hợp công nghệ tiên phong và chất lượng quản lý tiêu
                                chuẩn cao, Cánh Cam sẽ gieo sự tự tin vào trang web để bạn thực sự tỏa sáng khi đạt mục
                                tiêu tăng doanh thu lẫn mức độ nhận
                                biết.
                            </p>
                            <a class="btn btn-icon-right btn-openpopup" href="/lien-lac#contactform">
                                <span>Báo giá</span><em class="lnr lnr-arrow-right"></em></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="step-circle">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 326.51 326.51">
                                        ...
                                        <g id="step-1" class="step-number active">
                                            <path style="fill: #f1f6fa;" class="step-bg"
                                                  d="M202.71,96.1A58,58,0,0,1,213.58,105a72.2,72.2,0,0,1,11.56,16.21h68.57c-8.83-26.08-23.89-46.94-43-62.06a127.38,127.38,0,0,0-19.35-12.6Z"></path>
                                            ...
                                            <line x1="231.16" y1="46.63" x2="202.71" y2="95.96"
                                                  style="fill: #231f20; stroke: #231f20; stroke-miterlimit: 10; stroke-width: 1px; opacity: 0.5;"></line>
                                        </g>
                                        <g id="step-2" class="step-number">
                                            ...
                                            <line x1="96.97" y1="49.42" x2="125.42" y2="98.75"
                                                  style="fill: #231f20; stroke: #231f20; stroke-miterlimit: 10; stroke-width: 1px; opacity: 0.5;"></line>
                                        </g>
                                        <g id="step-3" class="step-number">
                                            ...
                                            <line x1="32.86" y1="164.3" x2="94.09" y2="164.33"
                                                  style="fill: #231f20; stroke: #231f20; stroke-miterlimit: 10; stroke-width: 1px; opacity: 0.5;"></line>
                                        </g>
                                        <g id="step-4" class="step-number">
                                            ...
                                            <line x1="98.44" y1="276.63" x2="126.72" y2="227.65"
                                                  style="fill: #231f20; stroke: #231f20; stroke-miterlimit: 10; stroke-width: 1px; opacity: 0.5;"></line>
                                        </g>
                                        <g id="step-5" class="step-number">
                                            ...
                                            <line x1="201.68" y1="230.99" x2="230.62" y2="281.17"
                                                  style="fill: #231f20; stroke: #231f20; stroke-miterlimit: 10; stroke-width: 1px; opacity: 0.5;"></line>
                                        </g>
                        ...
                        <div class="col-lg-4">
                            <div class="step-content-wrap">
                                <div class="step-content" id="step-1" style="display: block;">
                                    <div class="content">
                                        <div class="title"><strong class="step">Bước 1: </strong>Thảo luận về dự án
                                        </div>
                                        <div class="subtitle">Thấu hiểu nhanh, hành động kịp thời.</div>
                                        <div class="text article-content">
                                            <p>
                                                Trước khi triển khai dự án, chúng tôi dành thời gian để đánh giá mục
                                                tiêu, động lực và yêu cầu đặt ra. Tất cả các vị trí tại Cánh Cam từ bộ
                                                phận thiết kế cho đến lập trình đều tham gia vào cả giai
                                ...
                                <div class="step-content" id="step-2" style="display: none;">
                                    <div class="content">
                                        ...
                                        <div class="subtitle">Nguồn tài nguyên giá trị nhất của doanh nghiệp là thời
                                            gian.
                                        </div>
                                        <div class="text article-content">
                                            <p>
                                                Do đó, việc hoạch định chi tiết là vô cùng cần thiết. Cánh Cam sẽ để
                                                khách hàng tham gia vào quá trình hoạch định quan trọng này, chia sẻ
                                                thông tin có liên quan đến dự án cũng như thảo luận trước
                                ...
                                <div class="step-content" id="step-3" style="display: none;">
                                    <div class="content">
                                        ...
                                        <div class="text article-content">
                                            <p>
                                                Hơn ai hết Cánh Cam hiểu được người dùng mục tiêu mới là người quyết
                                                định tính hiệu quả của trang web. Vì thế chúng tôi luôn chủ động tiếp
                                                cận để nắm bắt những ham muốn tiềm ẩn của người dùng và
                                                hình thành bức tranh tổng thể nhằm đưa ra một thiết kế hoàn toàn khác
                                                biệt và mới lạ so với các đối thủ trong ngành nhưng vẫn đảm bảo giá trị
                                                UX,UI cho người dùng, giúp doanh nghiệp trở nên khác
                                                biệt và nổi bật.
                                            </p>
                                            <ul>
                                ...
                                <div class="step-content" id="step-4" style="display: none;">
                                    <div class="content">
                                        ...
                                        <div class="text article-content">
                                            <p>
                                                Cánh Cam lập trình web-core trên nền tảng tân tiến nhất hiện nay, mang
                                                lại thuận tiện cho nhà quản trị web. Dễ dàng tích hợp các hệ thống như
                                                ERP, CRM, Digital Marketing, Cổng thanh toán, đối tác
                                                giao nhận, Sàn TMĐT... Tối ưu tốc độ load web &amp; tiêu chí SEO là
                                ...
                                <div class="step-content" id="step-5" style="display: none;">
                                    <div class="content">
                                        ...
                                        <div class="text article-content">
                                            <p>
                                                Thiết kế website đẹp thôi là chưa đủ, quan trọng nhất là phải thể hiện
                                                được điều khách hàng cần – nội dung tiếp thị và trải nghiệm sản
                                                phẩm/dịch vụ trên kênh online. Cánh Cam luôn bắt đầu mỗi dự
                                                án từ việc lên chiến lược nội dung bài bản gồm mục đích, mục tiêu và lộ
                                                trình đi đến thành công. Nhờ nội dung ấn tượng, dịch vụ/sản phẩm của bạn
                                                sẽ được thể hiện chi tiết, dễ hiểu, gần gũi, súc
                                ...
                                <div class="step-content" id="step-6" style="display: none;">
                                    <div class="content">
                                        ...
                                        <div class="text article-content">
                                            <p>
                                                Chọn Cánh Cam, bạn hoàn toàn có thể yên tâm về một trang web xứng tầm,
                                                xác lập được vị thế của doanh nghiệp bạn trên thị trường. Chúng tôi sẵn
                                                lòng trở thành người bạn đồng hành cùng chặng đường
                                                phát triển thương hiệu online của doanh nghiệp bắt đầu từ lúc website
                                                vận hành chính thức.
                                            </p>
                                            <ul>
                                                <li>Hoạch định nội dung và xác định keyword</li>
            ...
            <div class="container">
                ...
                <div class="blog-list blog-slider">
                    <div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-multirow">
                        <div class="swiper-wrapper" style="width: 1661px; transform: translate3d(0px, 0px, 0px);">
                            <div class="swiper-slide swiper-slide-active" data-swiper-column="0" data-swiper-row="0"
                                 style="order: 0; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-bat-dong-san" target="_self"
                                       title="Thiết kế website bất động sản">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc3f1f442a1455577559_thiet-ke-website-bat-dong-san-cao-cap-can-chu-y-dieu-gi.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-bat-dong-san" target="_self"
                                               title="Thiết kế website bất động sản">Thiết kế website bất động sản</a>
                                        </h3>
                                        <p class="blog-des">
                                            Thiết kế website bất động sản là một trong những phương pháp hàng đầu trong
                                            việc kinh doanh bất động sản, nhà đất.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide swiper-slide-next" data-swiper-column="0" data-swiper-row="1"
                                 style="-webkit-box-ordinal-group: 6; order: 6; margin-top: 25px; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-ngan-hang" target="_self"
                                       title="Thiết kế website tài chính - ngân hàng">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc3f1f442a1455577560_thiet-ke-website-ngan-hang-chuyen-nghiep.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-ngan-hang" target="_self"
                                               title="Thiết kế website tài chính - ngân hàng">Thiết kế website tài chính
                                                - ngân hàng</a>
                                        </h3>
                                        <p class="blog-des">
                                            Sở hữu trang web chính thống, mạnh mẽ, phản ánh hoạt động của ngân hàng là
                                            điều cần thiết phải lưu ý.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="1" data-swiper-row="0"
                                 style="-webkit-box-ordinal-group: 1; order: 1; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-dau-khi" target="_self"
                                       title="Thiết kế website dầu khí">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc3f1f442a1455577565_thiet-ke-website-dau-khi-chuyen-nghiep-an-tuong.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-dau-khi" target="_self"
                                               title="Thiết kế website dầu khí">Thiết kế website dầu khí</a>
                                        </h3>
                                        <p class="blog-des">
                                            Thiết kế website dầu khí chuyên nghiệp, ấn tượng sẽ giúp doanh nghiệp của
                                            bạn tăng tính cạnh tranh hơn trên thị trường online hiện nay.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="1" data-swiper-row="1"
                                 style="-webkit-box-ordinal-group: 7; order: 7; margin-top: 25px; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-thoi-trang" target="_self"
                                       title="Thiết kế website thời trang- may mặc">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc3f1f442a145557756f.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-thoi-trang" target="_self"
                                               title="Thiết kế website thời trang- may mặc">Thiết kế website thời trang-
                                                may mặc</a>
                                        </h3>
                                        <p class="blog-des">
                                            Để kinh doanh thời trang thành công, việc thiết kế website thời trang, may
                                            mặc là hết sức cần thiết.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="2" data-swiper-row="0"
                                 style="-webkit-box-ordinal-group: 2; order: 2; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-khach-san" target="_self"
                                       title="Thiết kế website khách sạn - Resort">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc3f1f442a1455577574.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-khach-san" target="_self"
                                               title="Thiết kế website khách sạn - Resort">Thiết kế website khách sạn -
                                                Resort</a>
                                        </h3>
                                        <p class="blog-des">
                                            Cánh Cam mang đến những mẫu thiết kế website khách sạn có giao diện đẹp,
                            ...
                            <div class="swiper-slide" data-swiper-column="2" data-swiper-row="1"
                                 style="-webkit-box-ordinal-group: 8; order: 8; margin-top: 25px; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-san-xuat-cong-nghiep" target="_self"
                                       title="Thiết kế website sản xuất công nghiệp">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc3f1f442a1455577579.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-san-xuat-cong-nghiep" target="_self"
                                               title="Thiết kế website sản xuất công nghiệp">Thiết kế website sản xuất
                                                công nghiệp</a>
                                        </h3>
                                        <p class="blog-des">
                                            Để tìm kiếm đối tác mới hoặc phục vụ cho việc truyền thông thương hiệu cần
                                            thực hiện thiết kế website sản xuất công nghiệp.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="3" data-swiper-row="0"
                                 style="-webkit-box-ordinal-group: 3; order: 3; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-benh-vien" target="_self"
                                       title="Thiết kế website bệnh viện">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc421f442a145557778f.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-benh-vien" target="_self"
                                               title="Thiết kế website bệnh viện">Thiết kế website bệnh viện</a>
                                        </h3>
                                        <p class="blog-des">
                                            Bất kể doanh nghiệp nào muốn khai thác hết tiềm năng trong ngành của mình
                                            đều cần có sự hỗ trợ từ các nền tảng trực tuyến.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="3" data-swiper-row="1"
                                 style="-webkit-box-ordinal-group: 9; order: 9; margin-top: 25px; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-logistic" target="_self"
                                       title="Thiết kế website Logistic">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc421f442a1455577799.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-logistic" target="_self"
                                               title="Thiết kế website Logistic">Thiết kế website Logistic</a>
                                        </h3>
                                        <p class="blog-des">
                                            Để phát triển ngành kinh doanh dịch vụ vận tải, doanh nghiệp cần thiết kế
                                            web Logistic chuyên nghiệp.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="4" data-swiper-row="0"
                                 style="-webkit-box-ordinal-group: 4; order: 4; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-yen-sao" target="_self"
                                       title="Thiết kế website yến sào">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc421f442a14555777a3.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-yen-sao" target="_self"
                                               title="Thiết kế website yến sào">Thiết kế website yến sào</a>
                                        </h3>
                                        <p class="blog-des">
                                            Cánh Cam cung cấp dịch vụ thiết kế website Yến Sào trọn gói, giao diện đẹp,
                                            dễ quản lý - sử dụng, quảng bá thương hiệu.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="4" data-swiper-row="1"
                                 style="-webkit-box-ordinal-group: 10; order: 10; margin-top: 25px; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-tuyen-dung" target="_self"
                                       title="Thiết kế website tuyển dụng">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc421f442a14555777a8.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-tuyen-dung" target="_self"
                                               title="Thiết kế website tuyển dụng">Thiết kế website tuyển dụng</a>
                                        </h3>
                                        <p class="blog-des">
                                            Thiết kế website tuyển dụng cần quan tâm điều gì? Địa chỉ nào thiết kế
                                            website tuyển dụng chuyên nghiệp, hiệu quả?
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="5" data-swiper-row="0"
                                 style="-webkit-box-ordinal-group: 5; order: 5; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-xay-dung" target="_self"
                                    ...
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-xay-dung" target="_self"
                                               title="Thiết kế website xây dựng">Thiết kế website xây dựng</a>
                                        </h3>
                                        <p class="blog-des">
                                            Thiết kế web xây dựng có vai trò quan trọng đối với các doanh nghiệp hoạt
                                            động trong lĩnh vực này.
                                        </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="swiper-slide" data-swiper-column="5" data-swiper-row="1"
                                 style="-webkit-box-ordinal-group: 11; order: 11; margin-top: 25px; width: 251.75px; margin-right: 25px;">
                                <figure>
                                    <a class="blog-img" href="/thiet-ke-website-giao-duc-truong-hoc" target="_self"
                                       title="Thiết kế website trường học">
                                        <img class="lazyload"
                                             data-src="{{$config->static}}/assets/images/thumbs/6150cc461f442a145557790d_thiet-ke-website-giao-duc-truong-hoc.jpeg"
                                             src="{{$config->static}}/assets/img/deafault-image.jpg"/>
                                    </a>
                                    <figcaption class="text-center">
                                        <h3 class="blog-name">
                                            <a href="/thiet-ke-website-giao-duc-truong-hoc" target="_self"
                                               title="Thiết kế website trường học">Thiết kế website trường học</a>
                                        </h3>
                                        <p class="blog-des">
                                            Đối với việc thiết kế website giáo dục, trường học cũng là một điều cần
                    ...
                    <div class="swiper-navigation">
                        <div class="swiper-btn swiper-btn-prev swiper-button-disabled" tabindex="0" role="button"
                             aria-label="Previous slide" aria-disabled="true"><em class="lnr lnr-chevron-left"></em>
                        </div>
                        <div class="swiper-btn swiper-btn-next" tabindex="0" role="button" aria-label="Next slide"
                             aria-disabled="false"><em class="lnr lnr-chevron-right"></em></div>
                    </div>
                </div>
                <div class="text-center">
                    <a class="btn btn-icon-right" href="/lien-lac"> <span>Liên hệ tư vấn</span><em
                                class="lnr lnr-phone-handset"></em></a>
                </div>
            </div>
        </section>
        ...
        <section class="service-english-6 section">
            <div class="container">
                <div class="row justify-center no-gutter">
                    <div class="col-lg-10">
                        ...
                        <div class="section-desc text-center leading-snug">
                            ...
                            <a class="btn btn-icon-right" target="_blank"
                               href="https://www.slideshare.net/Canhcamhere/canh-camcreativecontentcredentials"
                               rel="nofollow"> <span>Hồ sơ năng lực</span><em class="lnr lnr-enter-down"></em></a>
                        </div>
                ...
                <div class="team-slider">
                    <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev"
                                 data-swiper-slide-index="5" style="width: 1110px; margin-right: 30px;">
                                <div class="img">
                                    <img class="swiper-lazy"
                                         data-src="{{$config->static}}/assets/images/uploaded/banner/slide-06.jpg"
                                         src="{{$config->static}}/assets/img/deafault-image_770x510.jpg"/>
                            ...
                            <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0"
                                ...
                                <div class="img">
                                    <img class="swiper-lazy swiper-lazy-loaded"
                                         src="{{$config->static}}/assets/images/uploaded/banner/slide-01.jpg"/>
                                </div>
                            </div>
                            <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1"
                                ...
                                <div class="img">
                                    <img class="swiper-lazy"
                                         data-src="{{$config->static}}/assets/images/uploaded/banner/slide-02.jpg"
                                         src="{{$config->static}}/assets/img/deafault-image_770x510.jpg"/>
                                    <div class="swiper-lazy-preloader"></div>
                                </div>
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="2"
                                ...
                                <div class="img">
                                    <img class="swiper-lazy"
                                         data-src="{{$config->static}}/assets/images/uploaded/banner/slide-03.jpg"
                                         src="{{$config->static}}/assets/img/deafault-image_770x510.jpg"/>
                                    <div class="swiper-lazy-preloader"></div>
                                </div>
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="3"
                                ...
                                <div class="img">
                                    <img class="swiper-lazy"
                                         data-src="{{$config->static}}/assets/images/uploaded/banner/slide-04.jpg"
                                         src="{{$config->static}}/assets/img/deafault-image_770x510.jpg"/>
                                    <div class="swiper-lazy-preloader"></div>
                                </div>
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="4"
                                ...
                                <div class="img">
                                    <img class="swiper-lazy"
                                         data-src="{{$config->static}}/assets/images/uploaded/banner/slide-05.jpg"
                                         src="{{$config->static}}/assets/img/deafault-image_770x510.jpg"/>
                                    <div class="swiper-lazy-preloader"></div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-navigation">
                        <div class="swiper-btn swiper-btn-prev" tabindex="0" role="button" aria-label="Previous slide">
                            <em class="lnr lnr-chevron-left"></em></div>
                        <div class="swiper-btn swiper-btn-next" tabindex="0" role="button" aria-label="Next slide"><em
                                    class="lnr lnr-chevron-right"></em></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="client-slider">
                <div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-multirow">
                    <div class="swiper-wrapper" style="width: 2665px;">
                        <div class="swiper-slide swiper-slide-active" data-swiper-column="0" data-swiper-row="0"
                             style="order: 0; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/2.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide swiper-slide-next" data-swiper-column="0" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 10; order: 10; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/3.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="1" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 1; order: 1; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/4.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="1" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 11; order: 11; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/5.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="2" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 2; order: 2; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/6.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="2" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 12; order: 12; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/7.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="3" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 3; order: 3; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/8.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="3" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 13; order: 13; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/9.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="4" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 4; order: 4; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/10.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="4" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 14; order: 14; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/11.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="5" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 5; order: 5; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/12.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="5" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 15; order: 15; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/13.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="6" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 6; order: 6; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/14.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="6" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 16; order: 16; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/15.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="7" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 7; order: 7; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/16.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="7" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 17; order: 17; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/17.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="8" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 8; order: 8; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/18.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="8" data-swiper-row="1"
                             style="-webkit-box-ordinal-group: 18; order: 18; margin-top: 0px; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/19.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="swiper-slide" data-swiper-column="9" data-swiper-row="0"
                             style="-webkit-box-ordinal-group: 9; order: 9; width: 266.5px;">
                            <div class="img">
                                <img class="lazyload" src="{{$config->static}}/assets/img/deafault-image_120x120.jpg"
                                     width="153" height="130" data-src="{{$config->static}}/assets/Banner/20.jpg"
                                     alt=""/>
                            </div>
                        </div>
                    </div>
        ...
        <section class="service-vietnamese-10 section">
            <div class="container">
                <strong><span style="color: #f00;">CLICK LẤY MÃ GIẢM GIÁ</span></strong> : <strong><span
                            style="color: #f00;">1234568</span></strong>
                ...
                <div class="question_answer_container clear">
                    <div class="faqpage_container">
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    ...
                                    <ul>
                                        <li>
                                            Tên miền (domain): nếu thiết kế website giống như xây dựng 1 ngôi nhà thì
                                            tên miền chính là số nhà của bạn. Đây là địa chỉ giúp người dùng truy cập
                                            vào website của bạn. Tên miền nên ngắn gọn, dễ nhớ
                                            và ấn tượng, 1 số tên miền phổ biến: .vn, .com.vn
                                        </li>
                                        <li>
                                            Hosting: nếu tên miền được xem là địa chỉ nhà, thì hosting là mảnh đất nơi
                                            ngôi nhà được xây dựng. Hiểu đơn giản hosting là nơi lưu trữ toàn bộ thông
                                            tin và dữ liệu của website trên Internet. Lựa chọn
                                            hosting có tốc độ, dung lượng phù hợp với web và có tính bảo mật cao là rất
                                            cần thiết.
                                        </li>
                                        <li>Thiết kế website: chứa các dữ liệu website bao gồm bài viết, nội dung, hình
                                            ảnh, và các file mã lệnh (tên gọi khác là mã nguồn - source code)
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    Là thiết kế website thân thiện với công cụ tìm kiếm, thân thiện với người dùng và
                                    làm tăng khả năng đứng top trên bảng kết quả tìm kiếm.
                                </div>
                            </div>
                        </div>
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    ...
                                    <p>
                                        Chúng ta đang ở trong thời đại “Thế giới phẳng” mọi thứ đều được truyền đạt
                                        thông qua internet. Việc doanh nghiệp sở hữu một website chỉnh chu và hiện đại
                                        sẽ giúp gây ấn tượng mạnh không chỉ với các đối
                                        tác lớn trong nước mà còn có hiệu quả quảng bá với các khách hàng quốc tế.
                                    </p>
                                    <p>
                                        Nếu như văn phòng trong thực tế là nơi để thực hiện các giao dịch của doanh
                                        nghiệp, là nơi thể hiện bộ mặt của công ty và gây ấn tượng với khách hàng. Thì
                                        Website được xem như “văn phòng thứ hai” của mọi
                                        doanh nghiệp trên thị trường online.
                                    </p>
                                    <p>
                                        Xây dựng thương hiệu, nâng cao giá trị uy tín thương hiệu luôn là mục tiêu hàng
                                        đầu trong bản kế hoạch marketing của mỗi công ty. Và thiết kế website cho doanh
                                        nghiệp chính là một trong những việc đầu
                                        tiên sẽ phải xúc tiến nếu muốn chương trình truyền thông của doanh nghiệp mình
                                        đạt hiệu quả cao.
                                    </p>
                                    <p>
                                        Hiểu được tầm quan trọng của website. Trong mỗi dự án của mình, đội ngũ nhân
                                        viên Cánh Cam luôn nỗ lực hết mình mang đến những thiết kế web không chỉ có giá
                                        trị cao về thẩm mỹ mà còn đảm bảo được tính
                                        thân thiện với người dùng nhưng vẫn mang đến chất riêng biệt cho mỗi một thương
                                        hiệu của riêng doanh nghiệp, tập đoàn ấy. Giúp mỗi một khách hàng của mình đều
                                        phát huy được điểm mạnh và giá trị riêng biệt
                                        thông qua thiết kế website.
                                    </p>
                                    <p><strong>Gia tăng hiệu quả kinh doanh</strong></p>
                                    <p>Không chỉ đóng vai trò không thể thiếu trong việc truyền thông thương hiệu,
                                        website còn là một công cụ kinh doanh hàng đầu cho mỗi công ty, doanh
                                        nghiệp.</p>
                                    <p>
                                        Cũng giống như marketing việc xây dựng và thiết kế website là một công việc quan
                                        trọng đến nỗi trở thành tiêu điểm đầu tiên của mỗi kế hoạch kinh doanh, đặc biệt
                                        là các công ty, doanh nghiệp hoạt động
                                        trong lĩnh vực thương mại điện tử.
                                    </p>
                                    <p>
                                        Với Thiết kế website bán hàng tùy biến, Cánh Cam luôn đảm bảo doanh nghiệp bạn
                                        sẽ không bỏ lỡ bất kỳ cơ hội nào để có thêm khách hàng và gia tăng doanh thu.
                                        Việc đăng sản phẩm mới có thể tiến hành ở nhiều
                                        địa điểm chỉ cần có Smartphone, laptop hay Tablet. Việc tiếp nhận, xử lý đơn
                                        hàng, trả lời phản hồi khách hàng sẽ được thông báo với bạn ngay lập tức để giải
                                        quyết kịp thời.
                                    </p>
                                    <p>
                                        Cùng với hệ thống quản lý sản phẩm ưu việt của trang web sẽ khiến việc thực hiện
                                        các quy tắc quản lý sản phẩm trở nên đơn giản, nhanh chóng hơn. Bố cục trình bày
                                        sản phẩm rõ ràng, thông tin sản phẩm được
                                        hệ thống đầy đủ giúp người quản trị thao tác tiện lợi và quản lý đơn hàng hiệu
                                        quả hơn và gia tăng doanh số bán hàng hơn
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    <p><strong>Thế nào là làm website chuyên nghiệp và thiết kế webiste cao
                                            cấp?</strong></p>
                                    <p>
                                        Đây là câu hỏi dường như đã đỗi quen thuộc nhưng nó thực sự quan trọng đối với
                                        những người hoạt động trong lĩnh vực thiết kế website và quan trọng hơn cả, nó
                                        thực sự cần thiết đối với một doanh nghiệp
                                        đang muốn xây dựng, làm web chuyên nghiệp.
                                    </p>
                                    <p><strong>Chuyên nghiệp và cao cấp trong thiết kế</strong></p>
                                    <p>
                                        Thu hút và tạo được sự tin cậy cho người truy cập. Giao diện của website không
                                        nhất thiết phải được thiết kế thật cầu kỳ, sắc màu hay theo một trường phái nghệ
                                        thuật nào cả, mà ta nên hướng UI design
                                        (thiết kế giao diện người dùng) đến sự đơn giản và tinh tế trong thiết kế để khi
                                        nhìn vào có cảm giác thoải mái, dễ chịu cho khách hàng.
                                    </p>
                                    <p>
                                        Hiện nay có khá nhiều website trên thị trường Việt Nam đang mắc phải nhiều lỗi
                                        cơ bản trong việc viết website, các lỗi này có thể do nhà cung cấp dịch vụ thiết
                                        kế và cũng có thể do khách hàng nhưng phần
                                        lớn là do ý tưởng thiết kế của khách hàng và yêu cầu nhà thiết kế thực hiện
                                        theo.
                                    </p>
                                    <p>Một số những lỗi cơ bản trong thiết kế website thường gặp: bố cục rối mắt, không
                                        rõ ràng, quá dài, phối màu kém, hình ảnh kém chất lượng…</p>
                                    <p>
                                        Tóm lại về mảng thiết kế, ở phần này chúng tôi muốn hướng các bạn thiết kế một
                                        website thật đơn giản, vì đơn giản sẽ không khiến khách hàng cảm thấy nhàm chán.
                                        Bạn không nhất thiết phải chạy theo xu
                                        hướng, không nhất thiết phải làm thật đẹp, hoàn hảo hay mang tính nghệ thuật
                                        cao. Mà ở đây, người xem cần sự thoải mái khi nhìn vào nó, cần sự hài hòa trong
                                        màu sắc và khi đó, họ sẽ yêu quý và tin tưởng
                                        bạn hơn.
                                    </p>
                                    <p><strong>Chuyên nghiệp và cao cấp trong chất lượng</strong></p>
                                    <p>
                                        Một website đẹp cũng kèm theo đó là phải chất lượng. Chất lượng ở đây là gì?
                                        Không phải cứ sử dụng công nghệ mới nhất, hosting (server) tốt nhất ... là chất
                                        lượng, mà phải thực hiện được những tiêu chuẩn
                                        cơ bản sau:
                                    </p>
                                    <p>
                                        <strong>Được tối ưu:</strong> Website cần phải được tối ưu về tốc độ, trải
                                        nghiệm người dùng (UX design), tối ưu chuẩn SEO. Về tốc độ, truy cập nhanh hay
                                        chậm có thể do mạng của từng người, do hosting
                                        (server)... nhưng website nên được tối ưu về hình ảnh, cách load trang để đạt
                                        tốc độ tối đa, nhanh nhất có thể. Về SEO, cần tối ưu onpage đối với nội dung,
                                        các từ khoá ... để website của bạn có thể dễ
                                        dàng đứng trên top của công cụ tìm kiếm.
                                    </p>
                                    <p>
                                        <strong>Bảo mật:</strong> Bảo mật cho website là một điều tiên quyết mà bất cứ
                                        đơn vị <b>thiết kế web trọn gói</b> nào cũng phải lưu tâm, để đảm bảo ngăn chặn
                                        được việc tấn công, phá hoại của hacker gây
                                        ra mất mát dữ liệu, gián đoạn truy cập của người dùng tới website.
                                    </p>
                                    <p>
                                        <strong>Quản trị dễ dàng:</strong> Để một trang web thật sự đang “hoạt động” bạn
                                        cần phải đảm bảo được tính cập nhật cho website, điều này sẽ khiến bạn phải làm
                                        việc thường xuyên với website để cập nhật
                                        các bài post, tin tức, sản phẩm... Do đó, trang quản trị phải được xây dựng thân
                                        thiện, dễ dàng sử dụng để việc quản trị trở nên dễ dàng và nhanh chóng hơn.
                                    </p>
                                    <p>
                                        <strong>Nội dung:</strong> Để thu hút được lượng người truy cập đến website của
                                        bạn, không chỉ do ấn tượng về mặt thiết kế mà còn do nội dung đến từ website của
                                        bạn. Website phải có nội dung đầy đủ, phong
                                        phú, thông tin cần thiết cho người truy cập. Ngược lại, một website có nội dung
                                        sơ sài sẽ đồng nghĩa với việc website đó không có lượng truy cập cao.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    Boost sales hay còn được viết tắt thành Bosa, là một phương pháp với mục tiêu gia
                                    tăng doanh thu cho các doanh nghiệp lên đến mức cao nhất, thông qua việc thiết kế
                                    web site một cách tối ưu hóa, dựa theo chuẩn
                        ...
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    Tùy vào yêu cầu, tính năng riêng, chuyên sâu phù hợp với từng doanh nghiệp khác nhau
                                    mà mức giá của dịch vụ thiết kế website công ty và dịch vụ thiết kế website bán hàng
                                    sẽ khác nhau. Hãy liên hệ ngay với
                                    Cánh Cam, đội ngũ tư vấn viên của chúng tôi sẽ tư vấn chi tiết và báo giá nhanh
                                    chóng cho bạn.
                                </div>
                            </div>
                        </div>
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    Website sẽ là ấn tượng đầu tiên của khách hàng về doanh nghiệp. Chính vì vậy, một
                                    website có thiết kế độc đáo và chuyên nghiệp có thể khiến khách hàng cảm nhận được
                                    sự đáng tin cậy về quy cách hoạt động, cũng
                        ...
                        <div class="item_faq clear">
                            ...
                            <div class="acceptedanswer">
                                <div itemprop="text">
                                    Là một công ty chuyên thiết kế website bán hàng, Cánh Cam chuyên nghiệp trong quy
                                    trình làm việc, tác phong và hỗ trợ khách hàng tận tâm. Các sản phẩm mà Cánh Cam
                                    mang đến luôn đảm bảo chất lượng đã cam kết
        ...
        <section class="canhcam-blog-1 section-small">
            <div class="container">
                ...
                <div class="blog-list">
                    <div class="row">
                        <div class="col-sm-6 col-lg-4">
                            <figure>
                                <a class="blog-img" href="/luu-y-khi-thiet-ke-website" target="_self"
                                ...
                                <figcaption>
                                    <h2 class="blog-name">
                                        <a href="/luu-y-khi-thiet-ke-website" target="_self"
                                           title="9 lưu ý khi thiết kế website mà các doanh nghiệp không nên bỏ qua">9
                                            lưu ý khi thiết kế website mà các doanh nghiệp không nên bỏ qua</a>
                                    </h2>
                                    <time>17-06-2021</time>
                                    <div class="blog-des">
                                        Trong thời đại công nghệ số, website là nền tảng quảng cáo thương hiệu, sản phẩm
                                        được nhiều doanh nghiệp lựa chọn hàng đầu. Để website đem đến trải nghiệm tốt
                                        nhất, tăng chuyển đổi, doanh nghiệp cần quan
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <figure>
                                ...
                                <figcaption>
                                    <h2 class="blog-name">
                                        <a href="/thiet-ke-website-xay-dung" target="_self"
                                           title="Thiết kế website xây dựng cần lưu ý điều gì?">Thiết kế website xây
                                            dựng cần lưu ý điều gì?</a>
                                    </h2>
                                    <time>24-02-2021</time>
                                    <div class="blog-des">
                                        Thiết kế web xây dựng có vai trò quan trọng đối với các doanh nghiệp hoạt động
                                        trong lĩnh vực này.
                                    </div>
                                </figcaption>
                            </figure>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <figure>
                                <a class="blog-img" href="/thiet-ke-website-chuan-seo-la-gi" target="_self"
                                ...
                                <figcaption>
                                    <h2 class="blog-name">
                                        <a href="/thiet-ke-website-chuan-seo-la-gi" target="_self"
                                           title="Thế nào là website chuẩn SEO? Những điều cần nắm để thiết kế website chuẩn SEO năm 2021">
                                            Thế nào là website chuẩn SEO? Những điều cần nắm để thiết kế website chuẩn
                                            SEO năm 2021
                                        </a>
                                    </h2>
                                    <time>23-02-2021</time>
                                    <div class="blog-des">
                                        Hiện nay, song hành cùng sự phát triển mạnh mẽ của công nghệ thông tin, các
                                        website được xây dựng ngày càng phổ biến để đáp ứng nhu cầu quảng bá sản phẩm,
                                        thông tin doanh nghiệp đến khách hàng. Một trong
                                        những tiêu chí hàng đầu khi đề cập đến vấn đề thiết kế web đó là “chuẩn SEO”.
                                        Vậy, thực chất thiết kế website chuẩn SEO là gì?
                                    </div>
                                </figcaption>
                            </figure>
                        </div>
                ...
                <div class="text-center">
                    <a class="btn btn-icon-right" href="/blog"> <span>Xem tất cả</span><em
                                class="lnr lnr-arrow-right"></em></a>
                </div>
            </div>
        </section>
                        ...
                        <div class="wrap-form">
                            ...
                            <div class="form-group">
                                <input id="Footer_FullName" class="validate" data-rule-required="true"
                                       data-msg-required="Vui lòng nhập họ và tên" name="FormBeforeExitPage_FullName"
                                       placeholder="Họ và tên"/>
                            </div>
                            <div class="form-group">
                                <input id="Footer_CompanyName" class="validate" data-rule-required="true"
                                       data-msg-required="Vui lòng nhập tên công ty"
                                       name="FormBeforeExitPage_CompanyName" placeholder="Tên công ty"/>
                            </div>
                            <div class="form-group">
                                <input id="Footer_Phone" class="validate" data-rule-required="true"
                                       data-msg-required="Vui lòng nhập số điện thoại" maxlength="15"
                                       name="FormBeforeExitPage_Phone" placeholder="Số điện thoại"/>
                            </div>
