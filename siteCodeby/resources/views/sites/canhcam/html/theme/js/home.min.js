!(function (e, t) {
        ...
        on: function () {
            ...
            for (var u, h = s.split(" "), c = 0; c < this.length; c += 1) {
                ...
                if (r)
                    ...
                    for (u = 0; u < h.length; u += 1) {
                        var v = h[u];
                        p.dom7Listeners || (p.dom7Listeners = {}), p.dom7Listeners[v] || (p.dom7Listeners[v] = []), p.dom7Listeners[v].push({ listener: a, proxyListener: d }), p.addEventListener(v, d, o);
                    }
            }
            return this;
        },
        off: function () {
            ...
            for (var o = n.split(" "), l = 0; l < o.length; l += 1)
                for (var d = o[l], u = 0; u < this.length; u += 1) {
                    var h = this[u],
                        c = void 0;
                    if ((!s && h.dom7Listeners ? (c = h.dom7Listeners[d]) : s && h.dom7LiveListeners && (c = h.dom7LiveListeners[d]), c && c.length))
        ...
        l = {
            ...
            parseUrlQuery: function (e) {
                ...
                if ("string" == typeof o && o.length)
                    for (
                        r = (n = (o = o.indexOf("?") > -1 ? o.replace(/\S*\?/, "") : "").split("&").filter(function (e) {
                            return "" !== e;
                        })).length,
                        i = 0;
                        i < r;
                        ...
                        (s = n[i].replace(/#\S+/g, "").split("=")), (a[decodeURIComponent(s[0])] = void 0 === s[1] ? void 0 : decodeURIComponent(s[1]) || "");
                return a;
            },
            isObject: function (e) {
    ...
    var c = {
        ...
        updateSlides: function () {
            var e = this.params,
                ...
                h = a ? this.virtual.slides.length : u.length,
                c = [],
                p = [],
                f = [],
            ...
            if (void 0 !== n) {
                ...
                "string" == typeof b && b.indexOf("%") >= 0 && (b = (parseFloat(b.replace("%", "")) / 100) * n),
                    (this.virtualSize = -b),
                    s ? u.css({ marginLeft: "", marginTop: "" }) : u.css({ marginRight: "", marginBottom: "" }),
                    e.slidesPerColumn > 1 &&
                ...
                for (var S, k = e.slidesPerColumn, M = E / k, P = Math.floor(h / e.slidesPerColumn), z = 0; z < h; z += 1) {
                    C = 0;
                    var L = u.eq(z);
                    if (e.slidesPerColumn > 1) {
                        ...
                        "column" === e.slidesPerColumnFill
                            ? (($ = z - (A = Math.floor(z / k)) * k),
                                (A > P || (A === P && $ === k - 1)) && ($ += 1) >= k && (($ = 0), (A += 1)),
                                (D = A + ($ * E) / k),
                                L.css({ "-webkit-box-ordinal-group": D, "-moz-box-ordinal-group": D, "-ms-flex-order": D, "-webkit-order": D, order: D }))
                            : (A = z - ($ = Math.floor(z / M)) * M),
                            L.css("margin-" + (this.isHorizontal() ? "top" : "left"), 0 !== $ && e.spaceBetween && e.spaceBetween + "px")
                    ...
                    if ("none" !== L.css("display")) {
                        if ("auto" === e.slidesPerView) {
                            ...
                            if ((I && (L[0].style.transform = "none"), O && (L[0].style.webkitTransform = "none"), e.roundLengths)) C = this.isHorizontal() ? L.outerWidth(!0) : L.outerHeight(!0);
                            else if (this.isHorizontal()) {
                                var H = parseFloat(N.getPropertyValue("width")),
                                    j = parseFloat(N.getPropertyValue("padding-left")),
                                    q = parseFloat(N.getPropertyValue("padding-right")),
                                    B = parseFloat(N.getPropertyValue("margin-left")),
                                    R = parseFloat(N.getPropertyValue("margin-right")),
                                    F = N.getPropertyValue("box-sizing");
                                C = F && "border-box" === F ? H + B + R : H + j + q + B + R;
                            } else {
                                var X = parseFloat(N.getPropertyValue("height")),
                                    W = parseFloat(N.getPropertyValue("padding-top")),
                                    G = parseFloat(N.getPropertyValue("padding-bottom")),
                                    V = parseFloat(N.getPropertyValue("margin-top")),
                                    Y = parseFloat(N.getPropertyValue("margin-bottom")),
                                    _ = N.getPropertyValue("box-sizing");
                                C = _ && "border-box" === _ ? X + V + Y : X + W + G + V + Y;
                            }
                            I && (L[0].style.transform = I), O && (L[0].style.webkitTransform = O), e.roundLengths && (C = Math.floor(C));
                        } else (C = (n - (e.slidesPerView - 1) * b) / e.slidesPerView), e.roundLengths && (C = Math.floor(C)), u[z] && (this.isHorizontal() ? (u[z].style.width = C + "px") : (u[z].style.height = C + "px"));
                        u[z] && (u[z].swiperSlideSize = C),
                            ...
                            e.centeredSlides
                                ? ((x = x + C / 2 + w / 2 + b),
                                    ...
                                    T % e.slidesPerGroup == 0 && c.push(x),
                                    p.push(x))
                                : (e.roundLengths && (x = Math.floor(x)), T % e.slidesPerGroup == 0 && c.push(x), p.push(x), (x = x + C + b)),
                ...
                if (
                    ((this.virtualSize = Math.max(this.virtualSize, n) + m),
                        s && r && ("slide" === e.effect || "coverflow" === e.effect) && i.css({ width: this.virtualSize + e.spaceBetween + "px" }),
                ...
                if (!e.centeredSlides) {
                    ...
                    for (var Q = 0; Q < c.length; Q += 1) {
                        var J = c[Q];
                        e.roundLengths && (J = Math.floor(J)), c[Q] <= this.virtualSize - n && S.push(J);
                    }
                ...
                l.extend(this, { slides: u, snapGrid: c, slidesGrid: p, slidesSizesGrid: f }),
        ...
        updateProgress: function (e) {
            ...
            var t = this.params,
                ...
                a = s,
                o = r;
            0 === i ? ((n = 0), (s = !0), (r = !0)) : ((s = (n = (e - this.minTranslate()) / i) <= 0), (r = n >= 1)),
                l.extend(this, { progress: n, isBeginning: s, isEnd: r }),
        ...
        updateActiveIndex: function (e) {
            ...
            if (((t = s.indexOf(i) >= 0 ? s.indexOf(i) : Math.floor(u / r.slidesPerGroup)) >= s.length && (t = s.length - 1), u !== a)) {
                ...
                l.extend(this, { snapIndex: t, realIndex: c, previousIndex: a, activeIndex: u }), this.emit("activeIndexChange"), this.emit("snapIndexChange"), o !== c && this.emit("realIndexChange"), this.emit("slideChange");
    ...
    var p = {
        ...
        setTranslate: function (e, t) {
            ...
            this.isHorizontal() ? (a = i ? -e : e) : (o = e),
                ...
                n.virtualTranslate || (d.transforms3d ? s.transform("translate3d(" + a + "px, " + o + "px, 0px)") : s.transform("translate(" + a + "px, " + o + "px)")),
        ...
        slideTo: function (e, t, i, n) {
            ...
            return (
                ...
                (c && -v === s.translate) || (!c && v === s.translate)
                    ? (s.updateActiveIndex(r), a.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), "slide" !== a.effect && s.setTranslate(v), "reset" !== f && (s.transitionStart(i, f), s.transitionEnd(i, f)), !1)
                    : (0 !== t && d.transition
                        ? (s.setTransition(t),
                            s.setTranslate(v),
                        ...
                        : (s.setTransition(0), s.setTranslate(v), s.updateActiveIndex(r), s.updateSlidesClasses(), s.emit("beforeTransitionStart", t, n), s.transitionStart(i, f), s.transitionEnd(i, f)),
                        !0)
            );
        },
    ...
    var m = {
        ...
        loopFix: function () {
            ...
            if (i < s) (e = n.length - 3 * s + i), (e += s), this.slideTo(e, 0, !1, !0) && 0 !== d && this.setTranslate((l ? -this.translate : this.translate) - d);
            else if (("auto" === t.slidesPerView && i >= 2 * s) || i >= n.length - s) {
                (e = -n.length + i + s), (e += s), this.slideTo(e, 0, !1, !0) && 0 !== d && this.setTranslate((l ? -this.translate : this.translate) - d);
            }
        ...
        b = (function () {
            ...
            if (
                (s && ((n.os = "windows"), (n.osVersion = s[2]), (n.windows = !0)),
                    r && !s && ((n.os = "android"), (n.osVersion = r[2]), (n.android = !0), (n.androidChrome = i.toLowerCase().indexOf("chrome") >= 0)),
    ...
    function x(i) {
        ...
        if (!this.animating || !r.preventInteractionOnTransition) {
            ...
            if (
                ...
                if (r.noSwiping && n(o.target).closest(r.noSwipingSelector ? r.noSwipingSelector : "." + r.noSwipingClass)[0]) this.allowClick = !0;
                    ...
                    if (!h || !(d <= c || d >= t.screen.width - c)) {
                        if (
                            (l.extend(s, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }),
                                (a.startX = d),
                                (a.startY = u),
    ...
    function w(t) {
        ...
        if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
            if (!i.isTouchEvent || "mousemove" !== o.type) {
                ...
                if (!this.allowTouchMove) return (this.allowClick = !1), void (i.isTouched && (l.extend(r, { startX: d, startY: u, currentX: d, currentY: u }), (i.touchStartTime = l.now())));
                    ...
                    if (!(this.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(c, 2)) < this.params.threshold)) {
                        ...
                        if (void 0 === i.isScrolling)
                            (this.isHorizontal() && r.currentY === r.startY) || (this.isVertical() && r.currentX === r.startX)
                                ? (i.isScrolling = !1)
                                : h * h + c * c >= 25 && ((p = (180 * Math.atan2(Math.abs(c), Math.abs(h))) / Math.PI), (i.isScrolling = this.isHorizontal() ? p > s.touchAngle : 90 - p > s.touchAngle));
                            ...
                            if (
                                (s.touchReleaseOnEdges && (m = 0),
                                    f > 0 && i.currentTranslate > this.minTranslate()
                                        ? ((v = !1), s.resistance && (i.currentTranslate = this.minTranslate() - 1 + Math.pow(-this.minTranslate() + i.startTranslate + f, m)))
                                        : f < 0 && i.currentTranslate < this.maxTranslate() && ((v = !1), s.resistance && (i.currentTranslate = this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - f, m))),
    ...
    function T(e) {
        ...
        if (
            (t.allowClick &&
                (t.updateClickedSlide(u),
                    ...
                    p < 300 && c - i.lastClickTime < 300 && (i.clickTimeout && clearTimeout(i.clickTimeout), t.emit("doubleTap", u))),
        ...
        if (((i.isTouched = !1), (i.isMoved = !1), (i.startMoving = !1), (h = n.followFinger ? (r ? t.translate : -t.translate) : -i.currentTranslate), n.freeMode)) {
            ...
            if (n.freeModeMomentum) {
                ...
                if (x < t.maxTranslate())
                    n.freeModeMomentumBounce ? (x + t.maxTranslate() < -C && (x = t.maxTranslate() - C), (w = t.maxTranslate()), (E = !0), (i.allowMomentumBounce = !0)) : (x = t.maxTranslate()), n.loop && n.centeredSlides && (T = !0);
                else if (x > t.minTranslate())
                    n.freeModeMomentumBounce ? (x - t.minTranslate() > C && (x = t.minTranslate() + C), (w = t.minTranslate()), (E = !0), (i.allowMomentumBounce = !0)) : (x = t.minTranslate()), n.loop && n.centeredSlides && (T = !0);
            ...
            for (var M = 0, P = t.slidesSizesGrid[0], z = 0; z < o.length; z += n.slidesPerGroup)
                void 0 !== o[z + n.slidesPerGroup] ? h >= o[z] && h < o[z + n.slidesPerGroup] && ((M = z), (P = o[z + n.slidesPerGroup] - o[z])) : h >= o[z] && ((M = z), (P = o[o.length - 1] - o[o.length - 2]));
            var L = (h - o[M]) / P;
            if (p > n.longSwipesMs) {
    ...
    var S = {
        attachEvents: function () {
            var t = this.params,
                ...
                n = this.el,
                s = this.wrapperEl;
            (this.onTouchStart = x.bind(this)), (this.onTouchMove = w.bind(this)), (this.onTouchEnd = T.bind(this)), (this.onClick = C.bind(this));
            ...
            if (d.touch || (!d.pointerEvents && !d.prefixedPointerEvents)) {
                if (d.touch) {
                    ...
                    r.addEventListener(i.start, this.onTouchStart, o), r.addEventListener(i.move, this.onTouchMove, d.passiveListener ? { passive: !1, capture: a } : a), r.addEventListener(i.end, this.onTouchEnd, o);
                }
                ((t.simulateTouch && !b.ios && !b.android) || (t.simulateTouch && !d.touch && b.ios)) &&
                    (r.addEventListener("mousedown", this.onTouchStart, !1), e.addEventListener("mousemove", this.onTouchMove, a), e.addEventListener("mouseup", this.onTouchEnd, !1));
            } else r.addEventListener(i.start, this.onTouchStart, !1), e.addEventListener(i.move, this.onTouchMove, a), e.addEventListener(i.end, this.onTouchEnd, !1);
            (t.preventClicks || t.preventClicksPropagation) && r.addEventListener("click", this.onClick, !0), this.on(b.ios || b.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", E, !0);
        },
        detachEvents: function () {
            ...
            if (d.touch || (!d.pointerEvents && !d.prefixedPointerEvents)) {
                ...
                ((t.simulateTouch && !b.ios && !b.android) || (t.simulateTouch && !d.touch && b.ios)) &&
                    (r.removeEventListener("mousedown", this.onTouchStart, !1), e.removeEventListener("mousemove", this.onTouchMove, a), e.removeEventListener("mouseup", this.onTouchEnd, !1));
            ...
            (t.preventClicks || t.preventClicksPropagation) && r.removeEventListener("click", this.onClick, !0), this.off(b.ios || b.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", E);
        },
    };
    var k,
        M = {
                ...
                if (s && (!s || 0 !== Object.keys(s).length)) {
                    ...
                    if (r && this.currentBreakpoint !== r) {
                        ...
                        var o = a || this.originalParams,
                            d = n.loop && o.slidesPerView !== n.slidesPerView;
                        l.extend(this.params, o),
                            ...
                            d && t && (this.loopDestroy(), this.loopCreate(), this.updateSlides(), this.slideTo(e - i + this.loopedSlides, 0, !1)),
    ...
    var z = {
            ...
            classes: {
                addClasses: function () {
                    ...
                    s.push(t.direction),
                        ...
                        b.ios && s.push("ios"),
                        (P.isIE || P.isEdge) && (d.pointerEvents || d.prefixedPointerEvents) && s.push("wp8-" + t.direction),
        ...
        A = (function (e) {
            function t() {
                ...
                1 === a.length && a[0].constructor && a[0].constructor === Object ? (r = a[0]) : ((s = (i = a)[0]), (r = i[1])),
                    r || (r = {}),
                    (r = l.extend({}, r)),
                    s && !r.el && (r.el = s),
                    e.call(this, r),
                ...
                var h = l.extend({}, z);
                u.useModulesParams(h), (u.params = l.extend({}, h, D, r)), (u.originalParams = l.extend({}, u.params)), (u.passedParams = l.extend({}, r)), (u.$ = n);
                var c = n(u.params.el);
                if ((s = c[0])) {
                    if (c.length > 1) {
                        var p = [];
                    ...
                    var f,
                        v,
                        m = c.children("." + u.params.wrapperClass);
                    return (
                        l.extend(u, {
                            $el: c,
                            el: s,
                            ...
                            touchEvents:
                                ((f = ["touchstart", "touchmove", "touchend"]),
                                    ...
                                    d.pointerEvents ? (v = ["pointerdown", "pointermove", "pointerup"]) : d.prefixedPointerEvents && (v = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
                                    (u.touchEventsTouch = { start: f[0], move: f[1], end: f[2] }),
                                    (u.touchEventsDesktop = { start: v[0], move: v[1], end: v[2] }),
        ...
        $ = { name: "device", proto: { device: b }, static: { device: b } },
        ...
        j = {
            ...
            create: function () {
                l.extend(this, { observer: { init: H.init.bind(this), attach: H.attach.bind(this), destroy: H.destroy.bind(this), observers: [] } });
            },
            on: {
                init: function () {
                    this.observer.init();
        ...
        q = {
            update: function (e) {
                ...
                if ((l.extend(t.virtual, { from: w, to: T, offset: E, slidesGrid: t.slidesGrid }), h === w && c === T && !e)) return t.slidesGrid !== f && E !== m && t.slides.css(g, E + "px"), void t.updateProgress();
                ...
                else for (var M = h; M <= c; M += 1) (M < w || M > T) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
        ...
        B = {
            ...
            create: function () {
                l.extend(this, {
                    virtual: { update: q.update.bind(this), appendSlide: q.appendSlide.bind(this), prependSlide: q.prependSlide.bind(this), renderSlide: q.renderSlide.bind(this), slides: this.params.virtual.slides, cache: {} },
                });
            },
            on: {
                beforeInit: function () {
        ...
        R = {
            handle: function (i) {
                ...
                if (!(s.shiftKey || s.altKey || s.ctrlKey || s.metaKey || (e.activeElement && e.activeElement.nodeName && ("input" === e.activeElement.nodeName.toLowerCase() || "textarea" === e.activeElement.nodeName.toLowerCase())))) {
                    ...
                    this.isHorizontal()
                        ? ((37 !== r && 39 !== r) || (s.preventDefault ? s.preventDefault() : (s.returnValue = !1)), ((39 === r && !n) || (37 === r && n)) && this.slideNext(), ((37 === r && !n) || (39 === r && n)) && this.slidePrev())
                        : ((38 !== r && 40 !== r) || (s.preventDefault ? s.preventDefault() : (s.returnValue = !1)), 40 === r && this.slideNext(), 38 === r && this.slidePrev()),
        ...
        F = {
            ...
            create: function () {
                l.extend(this, { keyboard: { enabled: !1, enable: R.enable.bind(this), disable: R.disable.bind(this), handle: R.handle.bind(this) } });
            },
            on: {
                init: function () {
    ...
    var X = {
            ...
            if ((s.invert && (r = -r), n.params.freeMode)) {
                ...
                if (
                    (d >= n.minTranslate() && (d = n.minTranslate()),
                        ...
                        ((!u && n.isBeginning) || (!h && n.isEnd)) && n.updateSlidesClasses(),
                        n.params.freeModeSticky &&
                        (clearTimeout(n.mousewheel.timeout),
                            (n.mousewheel.timeout = l.nextTick(function () {
                                n.slideToClosest();
                            }, 300))),
                        n.emit("scroll", i),
        ...
        enable: function () {
            ...
            return (
                ...
                e.on(X.event, this.mousewheel.handle),
        ...
        disable: function () {
            ...
            if (!this.mousewheel.enabled) return !1;
            var e = this.$el;
            return "container" !== this.params.mousewheel.eventsTarged && (e = n(this.params.mousewheel.eventsTarged)), e.off(X.event, this.mousewheel.handle), (this.mousewheel.enabled = !1), !0;
        },
    },
        W = {
            update: function () {
                ...
                if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                        ...
                        if (
                            ...
                            u.each(function (e, s) {
                                ...
                                a === i && r.addClass(t.bulletActiveClass),
                                    t.dynamicBullets &&
                                    (a >= o && a <= l && r.addClass(t.bulletActiveClass + "-main"),
                                        a === o &&
                                        r
                                            .prev()
                    ...
                    if (("fraction" === t.type && (r.find("." + t.currentClass).text(t.formatFractionCurrent(i + 1)), r.find("." + t.totalClass).text(t.formatFractionTotal(a))), "progressbar" === t.type)) {
                        ...
                        var y = (i + 1) / a,
                            b = 1,
                            x = 1;
                        "horizontal" === g ? (b = y) : (x = y),
                            r
                                .find("." + t.progressbarFillClass)
                                .transform("translate3d(0,0,0) scaleX(" + b + ") scaleY(" + x + ")")
                                .transition(this.params.speed);
                    }
                    "custom" === t.type && t.renderCustom ? (r.html(t.renderCustom(this, i + 1, a)), this.emit("paginationRender", this, r[0])) : this.emit("paginationUpdate", this, r[0]),
            ...
            setTranslate: function () {
                if (this.params.scrollbar.el && this.scrollbar.el) {
                    ...
                    t ? ((u = -u) > 0 ? ((l = n - u), (u = 0)) : -u + n > s && (l = s + u)) : u < 0 ? ((l = n + u), (u = 0)) : u + n > s && (l = s - u),
                        this.isHorizontal()
                            ? (d.transforms3d ? r.transform("translate3d(" + u + "px, 0, 0)") : r.transform("translateX(" + u + "px)"), (r[0].style.width = l + "px"))
                            : (d.transforms3d ? r.transform("translate3d(0px, " + u + "px, 0)") : r.transform("translateY(" + u + "px)"), (r[0].style.height = l + "px")),
                        o.hide &&
            ...
            updateSize: function () {
                if (this.params.scrollbar.el && this.scrollbar.el) {
                    ...
                    (n = "auto" === this.params.scrollbar.dragSize ? s * r : parseInt(this.params.scrollbar.dragSize, 10)),
                        ...
                        l.extend(e, { trackSize: s, divider: r, moveDivider: a, dragSize: n }),
            ...
            enableDraggable: function () {
                if (this.params.scrollbar.el) {
                    var t = this.scrollbar,
                        ...
                        s = this.params,
                        r = t.$el[0],
                        a = !(!d.passiveListener || !s.passiveListeners) && { passive: !1, capture: !1 },
                        o = !(!d.passiveListener || !s.passiveListeners) && { passive: !0, capture: !1 };
                    d.touch
                        ? (r.addEventListener(i.start, this.scrollbar.onDragStart, a), r.addEventListener(i.move, this.scrollbar.onDragMove, a), r.addEventListener(i.end, this.scrollbar.onDragEnd, o))
                        : (r.addEventListener(n.start, this.scrollbar.onDragStart, a), e.addEventListener(n.move, this.scrollbar.onDragMove, a), e.addEventListener(n.end, this.scrollbar.onDragEnd, o));
                }
            },
            disableDraggable: function () {
                if (this.params.scrollbar.el) {
                    var t = this.scrollbar,
                        ...
                        o = !(!d.passiveListener || !s.passiveListeners) && { passive: !0, capture: !1 };
                    d.touch
                        ? (r.removeEventListener(i.start, this.scrollbar.onDragStart, a), r.removeEventListener(i.move, this.scrollbar.onDragMove, a), r.removeEventListener(i.end, this.scrollbar.onDragEnd, o))
                        : (r.removeEventListener(n.start, this.scrollbar.onDragStart, a), e.removeEventListener(n.move, this.scrollbar.onDragMove, a), e.removeEventListener(n.end, this.scrollbar.onDragEnd, o));
                }
            },
            init: function () {
                if (this.params.scrollbar.el) {
                    ...
                    0 === r.length && ((r = n('<div class="' + this.params.scrollbar.dragClass + '"></div>')), s.append(r)), l.extend(e, { $el: s, el: s[0], $dragEl: r, dragEl: r[0] }), i.draggable && e.enableDraggable();
                }
            },
            destroy: function () {
        ...
        Y = {
            ...
            setTranslate: function () {
                ...
                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function (t, i) {
                    ...
                    i.each(function (t, i) {
                        var a = i.progress;
                        e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (a += Math.ceil(t / 2) - s * (r.length - 1)),
        ...
        _ = {
            ...
            onGestureChange: function (e) {
                ...
                n.$imageEl &&
                    0 !== n.$imageEl.length &&
                    (d.gestures ? (i.scale = e.scale * i.currentScale) : (i.scale = (n.scaleMove / n.scaleStart) * i.currentScale),
                ...
                if (i.$imageEl && 0 !== i.$imageEl.length && ((this.allowClick = !1), n.isTouched && i.$slideEl)) {
                    n.isMoved ||
                        ((n.width = i.$imageEl[0].offsetWidth),
                            ...
                            (n.startX = l.getTranslate(i.$imageWrapEl[0], "x") || 0),
                            (n.startY = l.getTranslate(i.$imageWrapEl[0], "y") || 0),
            ...
            in: function (e) {
                var t,
                    ...
                    x = y.gesture,
                    w = y.image;
                (x.$slideEl || ((x.$slideEl = this.clickedSlide ? n(this.clickedSlide) : this.slides.eq(this.activeIndex)), (x.$imageEl = x.$slideEl.find("img, svg, canvas")), (x.$imageWrapEl = x.$imageEl.parent("." + b.containerClass))),
            ...
            out: function () {
                var e = this.zoom,
                    t = this.params.zoom,
                    i = e.gesture;
                i.$slideEl || ((i.$slideEl = this.clickedSlide ? n(this.clickedSlide) : this.slides.eq(this.activeIndex)), (i.$imageEl = i.$slideEl.find("img, svg, canvas")), (i.$imageWrapEl = i.$imageEl.parent("." + t.containerClass))),
                    i.$imageEl &&
                    0 !== i.$imageEl.length &&
                    ((e.scale = 1),
                        (e.currentScale = 1),
        ...
        U = {
                                ...
                                if (null != i && i && (!i || i.params) && !i.destroyed) {
                                    if (
                                        (l
                                            ...
                                            : (u && (o.attr("srcset", u), o.removeAttr("data-srcset")), h && (o.attr("sizes", h), o.removeAttr("data-sizes")), d && (o.attr("src", d), o.removeAttr("data-src"))),
            ...
            load: function () {
                ...
                else if (l > 1) for (var h = r; h < r + l; h += 1) d(h) && e.lazy.loadInSlide(h);
        ...
        K = {
            ...
            setTranslate: function (e, t) {
                ...
                if (Array.isArray(r)) for (var o = 0; o < r.length; o += 1) r[o] !== t && r[o] instanceof A && a(r[o]);
            ...
            setTransition: function (e, t) {
                ...
                if (Array.isArray(s)) for (i = 0; i < s.length; i += 1) s[i] !== t && s[i] instanceof A && r(s[i]);
            ...
            setHistory: function (e, i) {
                if (this.history.initialized && this.params.history.enabled) {
                    var n = this.slides.eq(i),
                        s = J.slugify(n.attr("data-history"));
        ...
        ie = {
            setTranslate: function () {
                ...
                d.shadow &&
                    (u
                        ? (0 === (e = i.find(".swiper-cube-shadow")).length && ((e = n('<div class="swiper-cube-shadow"></div>')), i.append(e)), e.css({ height: r + "px" }))
                ...
                for (var p = 0; p < s.length; p += 1) {
                    ...
                    if ((y <= 1 && y > -1 && ((c = 90 * v + 90 * y), o && (c = 90 * -v - 90 * y)), f.transform(T), d.slideShadows)) {
                        ...
                        0 === E.length && ((E = n('<div class="swiper-slide-shadow-' + (u ? "left" : "top") + '"></div>')), f.append(E)),
                            0 === C.length && ((C = n('<div class="swiper-slide-shadow-' + (u ? "right" : "bottom") + '"></div>')), f.append(C)),
                ...
                if (
                    ...
                    if (u) e.transform("translate3d(0px, " + (r / 2 + d.shadowOffset) + "px, " + -r / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + d.shadowScale + ")");
                        ...
                        var S = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90),
                            ...
                            z = d.shadowScale / k,
                            L = d.shadowOffset;
                        e.transform("scale3d(" + M + ", 1, " + z + ") translate3d(0px, " + (a / 2 + L) + "px, " + -a / 2 / z + "px) rotateX(-90deg)");
                    }
                var D = P.isSafari || P.isUiWebView ? -l / 2 : 0;
                i.transform("translate3d(0px,0," + D + "px) rotateX(" + (this.isHorizontal() ? 0 : c) + "deg) rotateY(" + (this.isHorizontal() ? -c : 0) + "deg)");
            },
            setTransition: function (e) {
                var t = this.$el;
            ...
            setTranslate: function () {
                for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                    ...
                    if ((this.isHorizontal() ? t && (a = -a) : ((d = l), (l = 0), (o = -a), (a = 0)), (s[0].style.zIndex = -Math.abs(Math.round(r)) + e.length), this.params.flipEffect.slideShadows)) {
                        ...
                        0 === u.length && ((u = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>')), s.append(u)),
                            0 === h.length && ((h = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>')), s.append(h)),
            ...
            setTranslate: function () {
                for (
                    ...
                    var v = i.eq(p),
                        ...
                        w = o ? 0 : a.stretch * g,
                        T = o ? a.stretch * g : 0;
                    Math.abs(T) < 0.001 && (T = 0), Math.abs(w) < 0.001 && (w = 0), Math.abs(x) < 0.001 && (x = 0), Math.abs(y) < 0.001 && (y = 0), Math.abs(b) < 0.001 && (b = 0);
                    var E = "translate3d(" + T + "px," + w + "px," + x + "px)  rotateX(" + b + "deg) rotateY(" + y + "deg)";
                    if ((v.transform(E), (v[0].style.zIndex = 1 - Math.abs(Math.round(g))), a.slideShadows)) {
                        ...
                        0 === C.length && ((C = n('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>')), v.append(C)),
                            0 === S.length && ((S = n('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>')), v.append(S)),
        ...
        re = {
            ...
            update: function (e) {
                ...
                if (t) {
                    ...
                    else for (var u = 0; u < o; u += 1) t.slides.eq(this.realIndex + u).addClass(l);
                }
            },
        },
        ae = [
            ...
            },
            {
                ...
                create: function () {
                    l.extend(this, { navigation: { init: W.init.bind(this), update: W.update.bind(this), destroy: W.destroy.bind(this), onNextClick: W.onNextClick.bind(this), onPrevClick: W.onPrevClick.bind(this) } });
                },
                on: {
                    init: function () {
            ...
            },
            {
                ...
                create: function () {
                    l.extend(this, { pagination: { init: G.init.bind(this), render: G.render.bind(this), update: G.update.bind(this), destroy: G.destroy.bind(this), dynamicBulletIndex: 0 } });
                },
                on: {
                    init: function () {
            ...
            },
            {
                ...
                create: function () {
                    l.extend(this, { parallax: { setTransform: Y.setTransform.bind(this), setTranslate: Y.setTranslate.bind(this), setTransition: Y.setTransition.bind(this) } });
                },
                on: {
                    beforeInit: function () {
            ...
            },
            {
                ...
                create: function () {
                    var e = this;
                    l.extend(e, { a11y: { liveRegion: n('<span class="' + e.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') } }),
            ...
            },
            {
                ...
                create: function () {
                    l.extend(this, {
                        history: { init: J.init.bind(this), setHistory: J.setHistory.bind(this), setHistoryPopState: J.setHistoryPopState.bind(this), scrollToSlide: J.scrollToSlide.bind(this), destroy: J.destroy.bind(this) },
                    });
                },
                on: {
                    init: function () {
            ...
            },
            {
                ...
                create: function () {
                    l.extend(this, { flipEffect: { setTranslate: ne.setTranslate.bind(this), setTransition: ne.setTransition.bind(this) } });
                },
                on: {
                    beforeInit: function () {
            ...
            },
            {
                ...
                create: function () {
                    l.extend(this, { coverflowEffect: { setTranslate: se.setTranslate.bind(this), setTransition: se.setTransition.bind(this) } });
                },
                on: {
                    beforeInit: function () {
            ...
            },
            {
                ...
                create: function () {
                    l.extend(this, { thumbs: { swiper: null, init: re.init.bind(this), update: re.update.bind(this), onThumbClick: re.onThumbClick.bind(this) } });
                },
                on: {
                    beforeInit: function () {
                        var e = this.params.thumbs;
    ...
    return void 0 === A.use && ((A.use = A.Class.use), (A.installModule = A.Class.installModule)), A.use(ae), A;
}),
    /*!
    ...
    (function (e, t) {
                ...
                for ("boolean" == typeof a && ((d = a), (a = arguments[o] || {}), o++), "object" == typeof a || v(a) || (a = {}), o === l && ((a = this), o--); o < l; o++)
                    if (null != (e = arguments[o]))
                        for (t in e)
                            (i = a[t]),
                                a !== (n = e[t]) &&
                                (d && n && (x.isPlainObject(n) || (s = Array.isArray(n)))
                                    ? (s ? ((s = !1), (r = i && Array.isArray(i) ? i : [])) : (r = i && x.isPlainObject(i) ? i : {}), (a[t] = x.extend(d, r, n)))
                                    : void 0 !== n && (a[t] = n));
                return a;
            }),
            x.extend({
                ...
                map: function (e, t, i) {
                    var n,
                        ...
                        r = 0,
                        o = [];
                    if (T(e)) for (n = e.length; r < n; r++) null != (s = t(e[r], r, i)) && o.push(s);
        ...
        var E =
            ...
            (function (e) {
                ...
                try {
                    A.apply((z = $.call(w.childNodes)), w.childNodes), z[w.childNodes.length].nodeType;
                } catch (e) {
                    A = {
                        apply: z.length
                            ? function (e, t) {
                    ...
                    if (!s && ((t ? t.ownerDocument || t : w) !== p && c(t), (t = t || p), v)) {
                        if (11 !== T && (h = Q.exec(e)))
                            if ((r = h[1])) {
                                ...
                                if ((r = h[3]) && i.getElementsByClassName && t.getElementsByClassName) return A.apply(n, t.getElementsByClassName(r)), n;
                            }
                ...
                for (t in ((i = re.support = {}),
                                ...
                                (M = t
                                    ...
                                    : function (e, t) {
                                        ...
                                        var i,
                                            ...
                                            a = [e],
                                            o = [t];
                                        if (!s || !r) return e === p ? -1 : t === p ? 1 : s ? -1 : r ? 1 : u ? N(u, e) - N(u, t) : 0;
                    ...
                    (re.matchesSelector = function (e, t) {
                        if (((e.ownerDocument || e) !== p && c(e), (t = t.replace(W, "='$1']")), i.matchesSelector && v && !k[t + " "] && (!g || !g.test(t)) && (!m || !m.test(t))))
                            try {
                                var n = y.call(e, t);
                                    ...
                                    : function (t, i, l) {
                                        ...
                                        if (m) {
                                            ...
                                            if (((f = [a ? m.firstChild : m.lastChild]), a && y)) {
                                                for (
                                                    b = (p = (d = (u = (h = (c = m)[x] || (c[x] = {}))[c.uniqueID] || (h[c.uniqueID] = {}))[e] || [])[0] === T && d[1]) && d[2], c = p && m.childNodes[p];
                                                    (c = (++p && c && c[v]) || (b = p = 0) || f.pop());
                                            ...
                                            } else if ((y && (b = p = (d = (u = (h = (c = t)[x] || (c[x] = {}))[c.uniqueID] || (h[c.uniqueID] = {}))[e] || [])[0] === T && d[1]), !1 === b))
                                                for (
                                                    ;
                                                    (c = (++p && c && c[v]) || (b = p = 0) || f.pop()) &&
                                                    ((o ? c.nodeName.toLowerCase() !== g : 1 !== c.nodeType) || !++b || (y && ((u = (h = c[x] || (c[x] = {}))[c.uniqueID] || (h[c.uniqueID] = {}))[e] = [T, b]), c !== t));
                    ...
                    return t.first
                        ...
                        : function (t, i, l) {
                            ...
                            if (l) {
                                ...
                                for (; (t = t[n]);)
                                    if (1 === t.nodeType || a)
                                        if (((u = (h = t[x] || (t[x] = {}))[t.uniqueID] || (h[t.uniqueID] = {})), s && s === t.nodeName.toLowerCase())) t = t[n] || t;
                                        else {
                        ...
                        oe(function (r, a, o, l) {
                            ...
                            if (r) {
                                if (s || e) {
                                    ...
                                    for (u = g.length; u--;) (h = g[u]) && (d = s ? N(r, h) : c[u]) > -1 && (r[d] = !(a[d] = h));
                                }
                            } else (g = xe(g === a ? g.splice(f, g.length) : g)), s ? s(null, a, g, l) : A.apply(a, g);
                        })
                    );
                }
                function Te(e) {
                    for (
                        ...
                        if ((i = n.relative[e[l].type])) c = [ye(be(c), i)];
                        else {
                            if ((i = n.filter[e[l].type].apply(null, e[l].matches))[x]) {
                                for (s = ++l; s < r && !n.relative[e[s].type]; s++);
                                return we(l > 1 && be(c), l > 1 && ge(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(R, "$1"), i, l < s && Te(e.slice(l, s)), s < r && Te((e = e.slice(s))), s < r && ge(e));
                            }
                            c.push(i);
                        }
                    return be(c);
                ...
                return (
                    ...
                    (a = re.tokenize = function (e, t) {
                        ...
                        for (o = e, l = [], d = n.preFilter; o;) {
                            for (a in ((i && !(s = F.exec(o))) || (s && (o = o.slice(s[0].length) || o), l.push((r = []))),
                                (i = !1),
                                (s = X.exec(o)) && ((i = s.shift()), r.push({ value: i, type: s[0].replace(R, " ") }), (o = o.slice(i.length))),
                                n.filter))
                                    ...
                                    var i = t.length > 0,
                                        ...
                                        r = function (r, a, o, l, u) {
                                            var h,
                                                ...
                                                S = E.length;
                                            for (u && (d = a === p || a || u); y !== S && null != (h = E[y]); y++) {
                                                if (s && h) {
                                                    for (f = 0, a || h.ownerDocument === p || (c(h), (o = !v)); (m = e[f++]);)
                                                        if (m(h, a || p, o)) {
                                                            l.push(h);
                                                            break;
                                                        }
                                            ...
                                            if (((g += y), i && y !== g)) {
                                                ...
                                                if (r) {
                                                    if (g > 0) for (; y--;) b[y] || x[y] || (x[y] = L.call(l));
                                                    x = xe(x);
                                                }
                    ...
                    (l = re.select = function (e, t, i, s) {
                        ...
                        if (((i = i || []), 1 === p.length)) {
                            ...
                            for (r = Y.needsContext.test(e) ? 0 : l.length; r-- && ((d = l[r]), !n.relative[(u = d.type)]);)
                                if ((h = n.find[u]) && (s = h(d.matches[0].replace(Z, ee), (J.test(l[0].type) && ve(t.parentNode)) || t))) {
                                    if ((l.splice(r, 1), !(e = s.length && ge(l)))) return A.apply(i, s), i;
                                    break;
                                }
                        }
                        return (c || o(e, p))(s, t, !v, i, !t || (J.test(e) && ve(t.parentNode)) || t), i;
                    }),
            ...
            x.each(
                ...
                function (e, t) {
                    x.fn[e] = function (i, n) {
                        ...
                        return "Until" !== e.slice(-5) && (n = i), n && "string" == typeof n && (s = x.filter(n, s)), this.length > 1 && ($[e] || x.uniqueSort(s), A.test(e) && s.reverse()), this.pushStack(s);
                    };
                }
            );
        var I = /[^\x20\t\r\n\f]+/g;
                                            ...
                                            d = function () {
                                                ...
                                                if (!(t < r)) {
                                                    ...
                                                    (d = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                        v(d)
                                                            ? s
                                                                ? d.call(e, a(r, i, O, s), a(r, i, H, s))
                                                                : (r++, d.call(e, a(r, i, O, s), a(r, i, H, s), a(r, i, O, i.notifyWith)))
                                                            : (n !== O && ((o = void 0), (l = [e])), (s || i.resolveWith)(o, l));
                                                }
                                            },
                                            u = s
                                                ? d
        ...
        (x.fn.ready = function (e) {
            ...
            x.extend({
                ...
                readyWait: 1,
                ready: function (e) {
                    (!0 === e ? --x.readyWait : x.isReady) || ((x.isReady = !0), (!0 !== e && --x.readyWait > 0) || B.resolveWith(n, [x]));
                },
            }),
            (x.ready.then = B.then),
            "complete" === n.readyState || ("loading" !== n.readyState && !n.documentElement.doScroll) ? e.setTimeout(x.ready) : (n.addEventListener("DOMContentLoaded", R), e.addEventListener("load", R));
        var F = function (e, t, i, n, s, r, a) {
            var o = 0,
                l = e.length,
                d = null == i;
            if ("object" === b(i)) for (o in ((s = !0), i)) F(e, t, o, i[o], !0, r, a);
            else if (
                void 0 !== n &&
                ((s = !0),
                    v(n) || (a = !0),
        ...
        function re(e, t, i, n) {
            ...
            if (u && u[3] !== d) {
                for (l /= 2, d = d || u[3], u = +l || 1; a--;) x.style(e, t, u + d), (1 - r) * (1 - (r = o() / l || 0.5)) <= 0 && (a = 0), (u /= r);
        ...
        function le(e, t) {
            for (var i, n, s = [], r = 0, a = e.length; r < a; r++)
                (n = e[r]).style &&
                    ((i = n.style.display),
                        t ? ("none" === i && ((s[r] = U.get(n, "display") || null), s[r] || (n.style.display = "")), "" === n.style.display && ne(n) && (s[r] = oe(n))) : "none" !== i && ((s[r] = "none"), U.set(n, "display", i)));
        ...
        function ye(e, t, i, n, s) {
            for (var r, a, o, l, d, u, h = t.createDocumentFragment(), c = [], p = 0, f = e.length; p < f; p++)
                if ((r = e[p]) || 0 === r)
                    if ("object" === b(r)) x.merge(c, r.nodeType ? [r] : r);
                    else if (ge.test(r)) {
            ...
            for (h.textContent = "", p = 0; (r = c[p++]);)
                ...
                else if (((d = x.contains(r.ownerDocument, r)), (a = pe(h.appendChild(r), "script")), d && fe(a), i)) for (u = 0; (r = a[u++]);) he.test(r.type || "") && i.push(r);
            return h;
        }
        (ve = n.createDocumentFragment().appendChild(n.createElement("div"))),
            ...
            ve.appendChild(me),
            (f.checkClone = ve.cloneNode(!0).cloneNode(!0).lastChild.checked),
            (ve.innerHTML = "<textarea>x</textarea>"),
            (f.noCloneChecked = !!ve.cloneNode(!0).lastChild.defaultValue);
        ...
        (x.event = {
                    ...
                    for (
                        ...
                        (p = v = (o = Te.exec(t[d]) || [])[1]),
                            ...
                            ((h = x.event.special[p] || {}),
                                ...
                                (h = x.event.special[p] || {}),
                                (u = x.extend({ type: p, origType: v, data: n, handler: i, guid: i.guid, selector: s, needsContext: s && x.expr.match.needsContext.test(s), namespace: f.join(".") }, r)),
                                (c = l[p]) || (((c = l[p] = []).delegateCount = 0), (h.setup && !1 !== h.setup.call(e, n, f, a)) || (e.addEventListener && e.addEventListener(p, a))),
                ...
                if (m && (l = m.events)) {
                    for (d = (t = (t || "").match(I) || [""]).length; d--;)
                        if (((p = v = (o = Te.exec(t[d]) || [])[1]), (f = (o[2] || "").split(".").sort()), p)) {
                            for (h = x.event.special[p] || {}, c = l[(p = (n ? h.delegateType : h.bindType) || p)] || [], o = o[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = c.length; r--;)
                                (u = c[r]),
                                    (!s && v !== u.origType) ||
                                    (i && i.guid !== u.guid) ||
                                    (o && !o.test(u.namespace)) ||
                                    (n && n !== u.selector && ("**" !== n || !u.selector)) ||
                                    (c.splice(r, 1), u.selector && c.delegateCount--, h.remove && h.remove.call(e, u));
            ...
            dispatch: function (e) {
                ...
                if (((o.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, o))) {
                    for (a = x.event.handlers.call(this, o, d), t = 0; (s = a[t++]) && !o.isPropagationStopped();)
                        for (o.currentTarget = s.elem, i = 0; (r = s.handlers[i++]) && !o.isImmediatePropagationStopped();)
                            (o.rnamespace && !o.rnamespace.test(r.namespace)) ||
                                ((o.handleObj = r), (o.data = r.data), void 0 !== (n = ((x.event.special[r.origType] || {}).handle || r.handler).apply(s.elem, l)) && !1 === (o.result = n) && (o.preventDefault(), o.stopPropagation()));
        ...
        function Oe(e, t, i, n) {
            ...
            var s,
                ...
                m = t[0],
                g = v(m);
            if (g || (c > 1 && "string" == typeof m && !f.checkClone && ze.test(m)))
                return e.each(function (s) {
                    var r = e.eq(s);
                    g && (t[0] = m.call(this, s, r.html())), Oe(r, t, i, n);
                });
            if (c && ((r = (s = ye(t, e[0].ownerDocument, !1, e, n)).firstChild), 1 === s.childNodes.length && (s = r), r || n)) {
                for (l = (o = x.map(pe(s, "script"), Ae)).length; h < c; h++) (d = s), h !== p && ((d = x.clone(d, !0, !0)), l && x.merge(o, pe(d, "script"))), i.call(e[h], d, h);
                if (l)
                    for (u = o[o.length - 1].ownerDocument, x.map(o, $e), h = 0; h < l; h++)
                        (d = o[h]), he.test(d.type || "") && !U.access(d, "globalEval") && x.contains(u, d) && (d.src && "module" !== (d.type || "").toLowerCase() ? x._evalUrl && x._evalUrl(d.src) : y(d.textContent.replace(Le, ""), u, d));
            }
            return e;
        }
        function He(e, t, i) {
        ...
        x.extend({
            ...
            clone: function (e, t, i) {
                ...
                if (!(f.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || x.isXMLDoc(e))) for (a = pe(o), n = 0, s = (r = pe(e)).length; n < s; n++) Ie(r[n], a[n]);
                if (t)
                    if (i) for (r = r || pe(e), a = a || pe(o), n = 0, s = r.length; n < s; n++) Ne(r[n], a[n]);
                    else Ne(e, o);
                ...
                html: function (e) {
                    return F(
                        ...
                        function (e) {
                            ...
                            if ("string" == typeof e && !Pe.test(e) && !ce[(ue.exec(e) || ["", ""])[1].toLowerCase()]) {
                                e = x.htmlPrefilter(e);
                                try {
        ...
        function Re(e, t, i) {
            ...
            return (
                ...
                ("" !== (a = i.getPropertyValue(t) || i[t]) || x.contains(e.ownerDocument, e) || (a = x.style(e, t)),
                    !f.pixelBoxStyles() && je.test(a) && Be.test(t) && ((n = o.width), (s = o.minWidth), (r = o.maxWidth), (o.minWidth = o.maxWidth = o.width = a), (a = i.width), (o.width = n), (o.minWidth = s), (o.maxWidth = r))),
                void 0 !== a ? a + "" : a
            );
        }
        function Fe(e, t) {
            ...
            function t() {
                if (u) {
                    (d.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0"),
                        ...
                        be.appendChild(d).appendChild(u);
        ...
        function Ue(e) {
            ...
            return (
                ...
                (t = x.cssProps[e] =
                    (function (e) {
                        if (e in _e) return e;
                        for (var t = e[0].toUpperCase() + e.slice(1), i = Ye.length; i--;) if ((e = Ye[i] + t) in _e) return e;
                    })(e) || e),
                t
            );
        }
        ...
        function Qe(e, t, i, n, s, r) {
            ...
            for (; a < 4; a += 2)
                "margin" === i && (l += x.css(e, i + ie[a], !0, s)),
                    n
                        ? ("content" === i && (l -= x.css(e, "padding" + ie[a], !0, s)), "margin" !== i && (l -= x.css(e, "border" + ie[a] + "Width", !0, s)))
                        : ((l += x.css(e, "padding" + ie[a], !0, s)), "padding" !== i ? (l += x.css(e, "border" + ie[a] + "Width", !0, s)) : (o += x.css(e, "border" + ie[a] + "Width", !0, s)));
            return !n && r >= 0 && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - r - l - o - 0.5))), l;
        }
        function Je(e, t, i) {
            var n = qe(e),
                s = Re(e, t, n),
            ...
            return (
                (a = a && (f.boxSizingReliable() || s === e.style[t])),
                ("auto" === s || (!parseFloat(s) && "inline" === x.css(e, "display", !1, n))) && ((s = e["offset" + t[0].toUpperCase() + t.slice(1)]), (a = !0)),
                (s = parseFloat(s) || 0) + Qe(e, t, i || (r ? "border" : "content"), a, n, s) + "px"
            );
        }
        ...
        x.extend({
            ...
            style: function (e, t, i, n) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var s,
                        ...
                        l = We.test(t),
                        d = e.style;
                    if ((l || (t = Ue(o)), (a = x.cssHooks[t] || x.cssHooks[o]), void 0 === i)) return a && "get" in a && void 0 !== (s = a.get(e, !1, n)) ? s : d[t];
                    "string" === (r = typeof i) && (s = te.exec(i)) && s[1] && ((i = re(e, t, s)), (r = "number")),
                        null != i &&
                        i == i &&
                        ("number" === r && (i += (s && s[3]) || (x.cssNumber[o] ? "" : "px")),
                            f.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (d[t] = "inherit"),
            ...
            css: function (e, t, i, n) {
                ...
                return (
                    We.test(t) || (t = Ue(o)),
                    (a = x.cssHooks[t] || x.cssHooks[o]) && "get" in a && (s = a.get(e, !0, i)),
                    void 0 === s && (s = Re(e, t, n)),
                ...
                x.cssHooks[t] = {
                    ...
                    set: function (e, i, n) {
                        var s,
                            ...
                            o = n && Qe(e, t, n, a, r);
                        return (
                            a && f.scrollboxSize() === r.position && (o -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - Qe(e, t, "border", !1, r) - 0.5)),
                            o && (s = te.exec(i)) && "px" !== (s[3] || "px") && ((e.style[t] = i), (i = x.css(e, t))),
                            Ke(0, i, o)
                        );
                    },
                };
        ...
        var et,
            ...
            nt = /queueHooks$/;
        function st() {
            tt && (!1 === n.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(st) : e.setTimeout(st, x.fx.interval), x.fx.tick());
        }
        function rt() {
            return (
                e.setTimeout(function () {
        ...
        function lt(e, t, i) {
            var n,
                ...
                l = function () {
                    if (s) return !1;
                    for (var t = et || rt(), i = Math.max(0, d.startTime + d.duration - t), n = 1 - (i / d.duration || 0), r = 0, a = d.tweens.length; r < a; r++) d.tweens[r].run(n);
            ...
            for (
                ...
                if ((n = lt.prefilters[r].call(d, e, u, d.opts))) return v(n.stop) && (x._queueHooks(d.elem, d.opts.queue).stop = n.stop.bind(n)), n;
            return (
                x.map(u, ot, d),
        ...
        (x.Animation = x.extend(lt, {
            ...
            tweener: function (e, t) {
                ...
                for (var i, n = 0, s = e.length; n < s; n++) (i = e[n]), (lt.tweeners[i] = lt.tweeners[i] || []), lt.tweeners[i].unshift(t);
            },
            prefilters: [
                function (e, t, i) {
                    var n,
                    ...
                    if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(p))
                        for (n in (h &&
                            ...
                            ((i.overflow = [f.overflow, f.overflowX, f.overflowY]),
                                ...
                                "none" === (u = x.css(e, "display")) && (d ? (u = d) : (le([e], !0), (d = e.style.display || d), (u = x.css(e, "display")), le([e]))),
                            ...
                            p))
                            l ||
                                (m ? "hidden" in m && (v = m.hidden) : (m = U.access(e, "fxshow", { display: d })),
                                    r && (m.hidden = !v),
                                    v && le([e], !0),
                                    c.done(function () {
            ...
            (x.speed = function (e, t, i) {
                var n = e && "object" == typeof e ? x.extend({}, e) : { complete: i || (!i && t) || (v(e) && e), duration: e, easing: (i && t) || (t && !v(t) && t) };
                return (
                ...
                stop: function (e, t, i) {
                    ...
                    return (
                        ...
                        this.each(function () {
                            ...
                            else for (s in a) a[s] && a[s].stop && nt.test(s) && n(a[s]);
                ...
                attr: function (e, t, i) {
                    ...
                    if (3 !== r && 8 !== r && 2 !== r)
                        return void 0 === e.getAttribute
                            ? x.prop(e, t, i)
                            : ((1 === r && x.isXMLDoc(e)) || (s = x.attrHooks[t.toLowerCase()] || (x.expr.match.bool.test(t) ? dt : void 0)),
                                void 0 !== i
                                    ? null === i
            ...
            x.each(x.expr.match.bool.source.match(/\w+/g), function (e, t) {
                ...
                ut[t] = function (e, t, n) {
                    var s,
                        r,
                        a = t.toLowerCase();
                    return n || ((r = ut[a]), (ut[a] = s), (s = null != i(e, t, n) ? a : null), (ut[a] = r)), s;
                };
            });
                ...
                propHooks: {
                    tabIndex: {
                        get: function (e) {
                            ...
                            return t ? parseInt(t, 10) : ht.test(e.nodeName) || (ct.test(e.nodeName) && e.href) ? 0 : -1;
                        },
                    },
                },
            ...
            x.fn.extend({
                ...
                toggleClass: function (e, t) {
                    ...
                    return "boolean" == typeof t && n
                        ...
                        : v(e)
                            ...
                            : this.each(function () {
                                var t, s, r, a;
                                if (n) for (s = 0, r = x(this), a = vt(e); (t = a[s++]);) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                ...
                hasClass: function (e) {
                    var t,
                        i,
                        n = 0;
                    for (t = " " + e + " "; (i = this[n++]);) if (1 === i.nodeType && (" " + pt(ft(i)) + " ").indexOf(t) > -1) return !0;
                    return !1;
                },
            });
        var mt = /\r/g;
                ...
                if (
                    ((o = f = l = s = s || n),
                        ...
                        (y.indexOf(".") > -1 && ((b = y.split(".")), (y = b.shift()), b.sort()),
                            ...
                            (p = x.event.special[y] || {}),
                            r || !p.trigger || !1 !== p.trigger.apply(s, i)))
                ) {
                    if (!r && !p.noBubble && !m(s)) {
                        for (d = p.delegateType || y, gt.test(d + y) || (o = o.parentNode); o; o = o.parentNode) g.push(o), (l = o);
                        l === (s.ownerDocument || n) && g.push(l.defaultView || l.parentWindow || e);
                    }
                    for (a = 0; (o = g[a++]) && !t.isPropagationStopped();)
                        (f = o),
                            (t.type = a > 1 ? d : p.bindType || y),
                            (c = (U.get(o, "events") || {})[t.type] && U.get(o, "handle")) && c.apply(o, i),
                            (c = u && o[u]) && c.apply && Y(o) && ((t.result = c.apply(o, i)), !1 === t.result && t.preventDefault());
                    return (
                        (t.type = y),
                        r ||
        ...
        function kt(e, t, i, n) {
            ...
            if (Array.isArray(t))
                x.each(t, function (t, s) {
                    i || Tt.test(e) ? n(e, s) : kt(e + "[" + ("object" == typeof s && null != s ? t : "") + "]", s, i, n);
                });
            else if (i || "object" !== b(t)) n(e, t);
            else for (s in t) kt(e + "[" + s + "]", t[s], i, n);
        }
            ...
            x.fn.extend({
                ...
                serializeArray: function () {
                    return this.map(function () {
                        ...
                        .filter(function () {
                            var e = this.type;
                            return this.name && !x(this).is(":disabled") && St.test(this.nodeName) && !Ct.test(e) && (this.checked || !de.test(e));
                        })
                        .map(function (e, t) {
                            var i = x(this).val();
                            return null == i
        ...
        (Ot.href = bt.href),
            x.extend({
                ...
                ajax: function (t, i) {
                    ...
                    if (
                        (g.promise(C),
                            (f.url = ((t || f.url || bt.href) + "").replace(At, bt.protocol + "//")),
                    ...
                    if ((f.data && f.processData && "string" != typeof f.data && (f.data = x.param(f.data, f.traditional)), jt($t, f, i, C), u)) return C;
                    for (c in ((h = x.event && f.global) && 0 == x.active++ && x.event.trigger("ajaxStart"),
                        ...
                        f.hasContent
                            ...
                            : ((p = f.url.slice(r.length)),
                                ...
                                !1 === f.cache && ((r = r.replace(zt, "$1")), (p = (wt.test(r) ? "&" : "?") + "_=" + xt++ + p)),
                                (f.url = r + p)),
                        f.ifModified && (x.lastModified[r] && C.setRequestHeader("If-Modified-Since", x.lastModified[r]), x.etag[r] && C.setRequestHeader("If-None-Match", x.etag[r])),
                    ...
                    if (((E = "abort"), y.add(f.complete), C.done(f.success), C.fail(f.error), (s = jt(Nt, f, i, C)))) {
                    ...
                    function S(t, i, n, o) {
                        ...
                        u ||
                            ((u = !0),
                                ...
                                d
                                    ? (f.ifModified && ((T = C.getResponseHeader("Last-Modified")) && (x.lastModified[r] = T), (T = C.getResponseHeader("etag")) && (x.etag[r] = T)),
                                        204 === t || "HEAD" === f.type ? (E = "nocontent") : 304 === t ? (E = "notmodified") : ((E = w.state), (c = w.data), (d = !(p = w.error))))
                                    : ((p = E), (!t && E) || ((E = "error"), t < 0 && (t = 0))),
                                (C.status = t),
                                (C.statusText = (i || E) + ""),
                                d ? g.resolveWith(v, [c, E, C]) : g.rejectWith(v, [C, E, p]),
                                C.statusCode(b),
                                (b = void 0),
                                h && m.trigger(d ? "ajaxSuccess" : "ajaxError", [C, f, d ? c : p]),
                                y.fireWith(v, [C, E]),
                                h && (m.trigger("ajaxComplete", [C, f]), --x.active || x.event.trigger("ajaxStop")));
                    }
                    return C;
                },
            ...
            x.each(["get", "post"], function (e, t) {
                x[t] = function (e, i, n, s) {
                    return v(i) && ((s = s || n), (n = i), (i = void 0)), x.ajax(x.extend({ url: e, type: t, dataType: s, data: i, success: n }, x.isPlainObject(e) && e));
                };
            }),
        ...
        x.ajaxSetup({
            ...
            x.ajaxPrefilter("json jsonp", function (t, i, n) {
                ...
                if (o || "jsonp" === t.dataTypes[0])
                    return (
                        (s = t.jsonpCallback = v(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                        o ? (t[o] = t[o].replace(Wt, "$1" + s)) : !1 !== t.jsonp && (t.url += (wt.test(t.url) ? "&" : "?") + t.jsonp + "=" + s),
                        ...
                        n.always(function () {
                            void 0 === r ? x(e).removeProp(s) : (e[s] = r), t[s] && ((t.jsonpCallback = i.jsonpCallback), Xt.push(s)), a && v(r) && r(a[0]), (a = r = void 0);
                        }),
                        "script"
                    );
            }),
            (f.createHTMLDocument = (((Ft = n.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Ft.childNodes.length)),
            (x.parseHTML = function (e, t, i) {
                return "string" != typeof e
                    ? []
                    : ("boolean" == typeof t && ((i = t), (t = !1)),
                        t || (f.createHTMLDocument ? (((s = (t = n.implementation.createHTMLDocument("")).createElement("base")).href = n.location.href), t.head.appendChild(s)) : (t = n)),
                        (a = !i && []),
                        (r = P.exec(e)) ? [t.createElement(r[1])] : ((r = ye([e], t, a)), a && a.length && x(a).remove(), x.merge([], r.childNodes)));
                var s, r, a;
            }),
            (x.fn.load = function (e, t, i) {
                var n,
                    ...
                    o = e.indexOf(" ");
                return (
                    o > -1 && ((n = pt(e.slice(o))), (e = e.slice(0, o))),
            ...
            x.each(["top", "left"], function (e, t) {
                x.cssHooks[t] = Fe(f.pixelPosition, function (e, i) {
                    if (i) return (i = Re(e, t)), je.test(i) ? x(e).position()[t] + "px" : i;
                });
            }),
        ...
        return (
            (x.noConflict = function (t) {
                return e.$ === x && (e.$ = Vt), t && e.jQuery === x && (e.jQuery = Gt), x;
            }),
            t || (e.jQuery = e.$ = x),
            x
        );
        ...
        var i = (function (e, t) {
            ...
            var i,
                ...
                b = function (e, n, s, r, a) {
                    ...
                    return s || (s = {}), (s.instance = i), o.initEvent(n, !r, !a), (o.detail = s), e.dispatchEvent(o), o;
                },
                x = function (t, i) {
                    var s;
                    !a && (s = e.picturefill || n.pf) ? (i && i.src && !t.getAttribute("srcset") && t.setAttribute("srcset", i.src), s({ reevaluate: !0, elements: [t] })) : i && i.src && (t.src = i.src);
                },
                w = function (e, t) {
                ...
                E =
                    ((P = []),
                        ...
                        (D = function () {
                            var e = L;
                            for (L = P.length ? z : P, k = !0, M = !1; e.length;) e.shift()();
                            k = !1;
                        }),
                        (A = function (e, i) {
                            k && !i ? e.apply(this, arguments) : (L.push(e), M || ((M = !0), (t.hidden ? l : d)(D)));
                        }),
                        (A._lsFlush = D),
                        A),
                C = function (e, t) {
            ...
            var $ =
                ((J = /^img$/i),
                    (Z = /^iframe$/i),
                    (ee = "onscroll" in e && !/(gle|ing)bot/.test(navigator.userAgent)),
                    (te = 0),
                    (ie = 0),
                    (ne = -1),
                    (se = function (e) {
                        ie--, e && e.target && y(e.target, se), (!e || ie < 0 || !e.target) && (ie = 0);
                    }),
                    (re = function (e) {
                        return null == Q && (Q = "hidden" == w(t.body, "visibility")), Q || ("hidden" != w(e.parentNode, "visibility") && "hidden" != w(e, "visibility"));
                    }),
                    (ae = function (e, i) {
                        var n,
                            r = e,
                            a = re(e);
                        for (Y -= i, K += i, _ -= i, U += i; a && (r = r.offsetParent) && r != t.body && r != s;)
                            (a = (w(r, "opacity") || 1) > 0) && "visible" != w(r, "overflow") && ((n = r.getBoundingClientRect()), (a = U > n.left && _ < n.right && K > n.top - 1 && Y < n.bottom + 1));
                        return a;
                    }),
                    (oe = function () {
                        var e,
                            ...
                            v,
                            m = i.elements;
                        if ((X = n.loadMode) && ie < 8 && (e = m.length)) {
                            for (
                                r = 0,
                                ne++,
                                f = (p = !n.expand || n.expand < 1 ? (s.clientHeight > 500 && s.clientWidth > 500 ? 500 : 370) : n.expand) * n.expFactor,
                                v = n.hFac,
                                Q = null,
                                te < f && ie < 1 && ne > 2 && X > 2 && !t.hidden ? ((te = f), (ne = 0)) : (te = X > 1 && ne > 1 && ie < 6 ? p : 0);
                                r < e;
                                r++
                            )
                                if (m[r] && !m[r]._lazyRace)
                                    if (ee)
                                        if (
                                            (((h = m[r].getAttribute("data-expand")) && (d = 1 * h)) || (d = te),
                                                c !== d && ((G = innerWidth + d * v), (V = innerHeight + d), (u = -1 * d), (c = d)),
                                                ...
                                                (K || U || _ || Y) &&
                                                (n.loadHidden || re(m[r])) &&
                                                ((R && ie < 3 && !h && (X < 3 || ne < 4)) || ae(m[r], d)))
                                        ) {
                                            if ((fe(m[r]), (l = !0), ie > 9)) break;
                                        } else !l && R && !o && ie < 4 && ne < 4 && X > 2 && (B[0] || n.preloadAfterLoad) && (B[0] || (!h && (K || U || _ || Y || "auto" != m[r].getAttribute(n.sizesAttr)))) && (o = B[0] || m[r]);
                                    else fe(m[r]);
                            o && !l && fe(o);
                        }
                    }),
                    (le = (function (e) {
                        var t,
                            ...
                            d =
                                u && a > 49
                                    ? function () {
                                        u(o, { timeout: a }), a !== n.ricTimeout && (a = n.ricTimeout);
                                    }
                                    : C(function () {
                                        l(o);
                                    }, !0);
                        return function (e) {
                            var n;
                            (e = !0 === e) && (a = 33), t || ((t = !0), (n = s - (r.now() - i)) < 0 && (n = 0), e || n < 9 ? d() : l(d, n));
                        };
                    })(oe)),
                    (de = function (e) {
                        m(e.target, n.loadedClass), g(e.target, n.loadingClass), y(e.target, he), b(e.target, "lazyloaded");
                    }),
                    (ue = C(de)),
                    (he = function (e) {
                        ue({ target: e.target });
                    ...
                    (ce = function (e) {
                        var t,
                            i = e.getAttribute(n.srcsetAttr);
                        (t = n.customMedia[e.getAttribute("data-media") || e.getAttribute("media")]) && e.setAttribute("media", t), i && e.setAttribute("srcset", i);
                    }),
                    (pe = C(function (e, t, i, s, r) {
                        var a, o, d, u, c, p;
                        (c = b(e, "lazybeforeunveil", t)).defaultPrevented ||
                            (s && (i ? m(e, n.autosizesClass) : e.setAttribute("sizes", s)),
                                (o = e.getAttribute(n.srcsetAttr)),
                                (a = e.getAttribute(n.srcAttr)),
                                r && (u = (d = e.parentNode) && h.test(d.nodeName || "")),
                                (p = t.firesLoad || ("src" in e && (o || a || u))),
                                (c = { target: e }),
                                p && (y(e, se, !0), clearTimeout(F), (F = l(se, 2500)), m(e, n.loadingClass), y(e, he, !0)),
                                u && f.call(d.getElementsByTagName("source"), ce),
                                o
                            ...
                            g(e, n.lazyClass),
                            E(function () {
                                (!p || (e.complete && e.naturalWidth > 1)) && (p ? se(c) : ie--, de(c));
                            }, !0);
                    })),
                    (fe = function (e) {
                        var t,
                            i = J.test(e.nodeName),
                            s = i && (e.getAttribute(n.sizesAttr) || e.getAttribute("sizes")),
                            r = "auto" == s;
                        ((!r && R) || !i || (!e.getAttribute("src") && !e.srcset) || e.complete || v(e, n.errorClass) || !v(e, n.lazyClass)) &&
                            ((t = b(e, "lazyunveilread").detail), r && N.updateElem(e, !0, e.offsetWidth), (e._lazyRace = !0), ie++, pe(e, t, r, s, i));
                    }),
                    (ve = function () {
                        if (!R)
                            if (r.now() - W < 999) l(ve, 999);
                            else {
                                var e = S(function () {
                                    (n.loadMode = 3), le();
                                });
                    ...
                    }),
                {
                    _: function () {
                        (W = r.now()),
                            ...
                            (B = t.getElementsByClassName(n.lazyClass + " " + n.preloadClass)),
                            o("scroll", le, !0),
                            o("resize", le, !0),
                            e.MutationObserver
                                ? new MutationObserver(le).observe(s, { childList: !0, subtree: !0, attributes: !0 })
                                : (s.addEventListener("DOMNodeInserted", le, !0), s.addEventListener("DOMAttrModified", le, !0), setInterval(le, 999)),
                            o("hashchange", le, !0),
                            ["focus", "mouseover", "click", "load", "transitionend", "animationend", "webkitAnimationEnd"].forEach(function (e) {
                                t.addEventListener(e, le, !0);
                            }),
                            /d$|^c/.test(t.readyState) ? ve() : (o("load", ve), t.addEventListener("DOMContentLoaded", le), l(ve, 2e4)),
                            i.elements.length ? (oe(), E._lsFlush()) : le();
                    },
                    checkElems: le,
                    unveil: fe,
                }),
                N =
                    ((H = C(function (e, t, i, n) {
                        var s, r, a;
                        if (((e._lazysizesWidth = n), (n += "px"), e.setAttribute("sizes", n), h.test(t.nodeName || ""))) for (r = 0, a = (s = t.getElementsByTagName("source")).length; r < a; r++) s[r].setAttribute("sizes", n);
                        i.detail.dataAttr || x(e, i.detail);
                    })),
                        (j = function (e, t, i) {
                            var n,
                                s = e.parentNode;
                            s && ((i = T(e, s, i)), (n = b(e, "lazybeforesizes", { width: i, dataAttr: !!t })).defaultPrevented || ((i = n.detail.width) && i !== e._lazysizesWidth && H(e, s, n, i)));
                        }),
                        (q = S(function () {
                            var e,
                                t = O.length;
                            if (t) for (e = 0; e < t; e++) j(O[e]);
                        })),
                    {
                        _: function () {
                            (O = t.getElementsByClassName(n.autosizesClass)), o("resize", q);
                        },
                        checkElems: q,
                        updateElem: j,
                    }),
            ...
            var O, H, j, q;
            var B, R, F, X, W, G, V, Y, _, U, K, Q, J, Z, ee, te, ie, ne, se, re, ae, oe, le, de, ue, he, ce, pe, fe, ve;
            return (i = { cfg: n, autoSizer: N, loader: $, init: I, uP: x, aC: m, rC: g, hC: v, fire: b, gW: T, rAF: E });
        })(e, e.document);
        (e.lazySizes = i), "object" == typeof module && module.exports && (module.exports = i);
    })(window),
    $(document).ready(function () {
        $(".toggle-menu").click(function () {
            $(this).toggleClass("is-active"), $("header .menu").toggleClass("show");
        }),
            $(window).on("scroll", function () {
                $(window).scrollTop() > 50 && $(window).width() > 992 ? $("header").addClass("minimal") : $("header").removeClass("minimal");
            }),
    ...
    $(".partialContents").each(function (e, t) {
        var i = $(this).data("url");
        i && i.length > 0 && $(this).load(i);
    });
var homeBanner = new Swiper(".canhcam-banner-1 .swiper-container", {
    pagination: { el: ".canhcam-banner-1 .swiper-pagination", dynamicBullets: !0, clickable: !0 },
    preloadImages: !1,
    lazy: { loadOnTransitionStart: !0 },
    autoplay: { delay: 4e3 },
}),
    testimonialSwiper = new Swiper(".canhcam-home-5 .swiper-container", { slidesPerView: 1, spaceBetween: 30, pagination: { el: ".canhcam-home-5 .swiper-pagination", type: "bullets", clickable: !0 } });
setTimeout(() => {
    new Swiper(".duan-noibat .swiper-right .swiper-container", {
        slidesPerView: 3,
        slidesPerColumn: 2,
        spaceBetween: 8,
        speed: 1700,
        navigation: { nextEl: ".duan-noibat .content-center .swiper-right", prevEl: ".duan-noibat .content-center .swiper-left" },
        breakpoints: { 1200: { slidesPerView: 3 } },
    });
}, 500),
    $(function () {
        $(window).width() < 768 && $(".canhcam-banner-1").innerHeight($(window).height() - $(".intro-header").innerHeight() - 180);
    });
