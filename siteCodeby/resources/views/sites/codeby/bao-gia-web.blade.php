    ...
    <main class="space-y-16">
        ...
        <section class="max-w-7xl mx-auto bg-white sm:px-6 lg:px-8">
            ...
            <div class="max-w-2xl mx-auto space-y-16 lg:hidden">
                ...
                @foreach($bgwOrg as $key => $item)
                    @if(preg_match('#goi-#mis', \Illuminate\Support\Arr::first(@$item['type'])))
                        <section>
                            <div class="px-4 mb-8">
                ...
                <table class="w-full h-px table-fixed">
                    ...
                    @foreach($bgw_cn['more'] as $key => $item)
                        <tr>
                            ...
                            @foreach($bgwOrg as $key1 => $item1)
                                @if(preg_match('#goi-#mis', \Illuminate\Support\Arr::first(@$item1['type'])))
                                    @php
            ...
            <span class="md:hidden">
              ...
              {{$bgw_khac['name']}}
                        ...
                        <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                            <a href="{{$bgw_khac['more']['button']['link']}}" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50">
