...
@section('main')
    ...
    <main class="">
    {{-- ky-gui-1 --}}
    @include($config->view.'/components/breadcrumbs', ['breadcrumbs'=>[['/', 'Trang chủ'], ['/san-pham', 'Sản phẩm'], ['/san-pham', 'Ký gửi']]])
            ...
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-12 sm:px-6 lg:px-8">
                <div class="relative bg-white shadow-xl">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        <!-- Contact information -->
                        <div class="relative overflow-hidden py-10 px-6 bg-[#144C4B] sm:px-10 xl:p-12">
                            ...
                            <h3 class="text-lg font-medium text-white">Bạn cần ký gửi đất thuộc khu đô thị Phú Mỹ Quảng
                                Ngãi?</h3>
                            <p class="mt-6 text-base text-indigo-50 max-w-3xl">Vui lòng điền thông bên cạnh
                                hoặc </p>
                            <div class="text-center mt-6">
                                <button class="bg-white rounded-lg h-9 px-5">
                                    Liên hệ ngay
                                </button>
                            </div>
                            ...
                            <dl class="mt-8 space-y-6">
                                ...
                                <dd class="flex text-base text-indigo-50">
                                    ...
                                    <span class="ml-3">0935 68 79 85</span>
                                </dd>
                                ...
                                <dd class="flex text-base text-indigo-50">
                                    ...
                                    <span class="ml-3">nhieubo@gmail.com</span>
                                </dd>
                            </dl>
                        ...
                        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                            <h3 class="text-lg font-medium text-gray-900">Thông tin ký gửi</h3>
                            <form action="#" method="POST"
                                  class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                <div>
                                    <label for="first-name" class="block text-sm font-medium text-gray-900">Họ và tên đệm</label>
                                    <div class="mt-1">
                                ...
                                <div>
                                    <label for="last-name" class="block text-sm font-medium text-gray-900">* Tên</label>
                                    <div class="mt-1">
...
{{--                                        <span id="phone-optional" class="text-sm text-gray-500">Optional</span>--}}
                                ...
                                <div class="sm:col-span-2">
                                    <label for="subject" class="block text-sm font-medium text-gray-900">* Số Lô</label>
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-2">
                                    <div class="flex justify-between">
                                        <label for="message"
                                               class="block text-sm font-medium text-gray-900">* Lời nhắn</label>
                                ...
                                <div class="sm:col-span-2 sm:flex sm:justify-end">
                                    <button type="submit"
                                            class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#144C4B] hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto">
                                        Gửi thông tin
                                    </button>
                                </div>
                            </form>
