        ...
        <section class="my-3 ">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3">
                <ul class="flex space-x-6">
                    <li class="">
                        <a href="#" class="text-base font-medium text-black relative group">
                            Ký gửi
                            ...
                            <a href="{{$config->base_url}}/chi-tiet?id={{$item['id']}}" class="flex ">
                                {{--<div class="flex-shrink-0">
                                    ...
                                    <img src="{{$media->set($item['images'])->first()}}"
                                         ...
                                         class="w-24 lg:w-[289px] object-center object-cover ">--}}{{--
                                    <img src="{{$media->set($item['images'])->first()}}"
                                         alt="Front side of mint cotton t-shirt with wavey lines pattern."
                                         class="w-24 lg:w-[289px] object-center object-cover ">
                                </div>--}}
                                <div class="flex-shrink-0">
                                    ...
                                    <img src="{{$media->set($item['images'])->first()}}"
                                         alt="Front side of mint cotton t-shirt with wavey lines pattern."
                                         class="w-24 lg:w-[289px] object-center object-cover ">--}}
                                    <div class="aspect-w-1 aspect-h-1 w-24 lg:w-[278px]">
                                    <img src="{{$media->set($item['images'])->first()}}"
                                         alt="Front side of mint cotton t-shirt with wavey lines pattern."
                                ...
                                <div class=" flex-1 flex flex-col ml-2">
                                    <div class="space-y-2 border border-black p-3">
                                        <h4 class="font-semibold truncate-2y w-[25rem] ">
                                            {{$item['title']}}
                                        </h4>
