        ...
        <div class="mx-auto w-full max-w-sm lg:w-96">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">
                    chưa có tài khoản
                    <a href="{{$config->base_url}}/dang-ky" class="font-medium text-indigo-600 hover:text-indigo-500">
                        đăng ký
                    </a>
                </p>
            </div>
            ...
            <div class="mt-8">
                <div class="mt-6" x-data>
                    ...
                    @endphp
                    <form action="#" method="POST" class="space-y-9" id="dang-ky-form">
                    ...
                    <script>
                        ...
                        form.addEventListener('submit', handleChange, false);
