<div x-data="{ show: false, list:['Phù hợp nhất', 'Giá từ thấp tới cao', 'Giá từ cao xuống thấp'], choose:null }" class="relative z-10 inline-block text-left">
    <div>
    ...
    <div x-show="show" @click.away="show = false"
         ...
         x-transition:leave-end="transform opacity-0 scale-95" class="origin-top-left absolute left-0 lg:right-0 z-10 mt-2 w-40 rounded-md shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
